...
TEST(AGU_MAVLINK, SYSTEM_STATUS_PACK)
{
    ...
    packet_in.Core_Module_Status_Mask = 963498296;
    packet_in.Telemetry_Module_Status_Mask = 93372036854776311ULL;
    packet_in.Storage_Module_Status_Mask = 963498504;
    packet_in.Radio_Link_Module_Status_Mask = 963498712;
    packet_in.Motor_Control_Module_Status_Mask = 963498920;
    packet_in.Guidance_Module_Status_Mask = 963499128;
    packet_in.Flight_Phase = 149;
    packet_in.Flight_Mode = 216;
    packet_in.Flight_Phase_Time = 963499336;
    packet_in.Emergency_Board_Status = 19315;
    packet_in.PSU_Status = 19419;
    packet_in.Emergency_Radio_Link_Status = 27;
    packet_in.Channel_4_PWM = 19523;
    packet_in.Channel_5_PWM = 19627;
    ...
    EXPECT_EQ(packet1.Emergency_Board_Status, packet2.Emergency_Board_Status);
    EXPECT_EQ(packet1.PSU_Status, packet2.PSU_Status);
    EXPECT_EQ(packet1.Emergency_Radio_Link_Status, packet2.Emergency_Radio_Link_Status);
    EXPECT_EQ(packet1.Channel_4_PWM, packet2.Channel_4_PWM);
    EXPECT_EQ(packet1.Channel_5_PWM, packet2.Channel_5_PWM);
}
...
TEST(AGU_MAVLINK_interop, SYSTEM_STATUS_PACK)
{
    ...
    EXPECT_EQ(packet_in.Emergency_Board_Status, packet2.Emergency_Board_Status);
    EXPECT_EQ(packet_in.PSU_Status, packet2.PSU_Status);
    EXPECT_EQ(packet_in.Emergency_Radio_Link_Status, packet2.Emergency_Radio_Link_Status);
    EXPECT_EQ(packet_in.Channel_4_PWM, packet2.Channel_4_PWM);
    EXPECT_EQ(packet_in.Channel_5_PWM, packet2.Channel_5_PWM);
...
TEST(AGU_MAVLINK, TELEMETRY_DATA_PACK)
{
    ...
    packet_in.GNSS_Altitude = 963499128;
    packet_in.Air_Speed_U = 21603;
    packet_in.Air_Speed_V = 21707;
    packet_in.Air_Speed_W = 21811;
    packet_in.Air_Temperature = 21915;
    packet_in.Altitude_Main_Altimeter = 963499336;
    packet_in.Altitude_Payload_Altimeter = 963499544;
    packet_in.Velocity_Horizontal = 22019;
    packet_in.Velocity_Vertical = 22123;
    packet_in.Position_Accuracy = 22227;
    packet_in.Speed_Accuracy = 22331;
    packet_in.Acceleration_X = 22435;
    packet_in.Acceleration_Y = 22539;
    packet_in.Acceleration_Z = 22643;
    packet_in.ECEF_Position_X = 325.0;
    packet_in.ECEF_Position_Y = 353.0;
    packet_in.ECEF_Position_Z = 381.0;
    packet_in.ECEF_Velocity_X = 409.0;
    packet_in.ECEF_Velocity_Y = 437.0;
    packet_in.ECEF_Velocity_Z = 465.0;
    packet_in.Roll_Angle = 22747;
    packet_in.Pitch_Angle = 22851;
    packet_in.Yaw_Angle = 22955;
    packet_in.Angular_Rate_Roll = 23059;
    packet_in.Angular_Rate_Pitch = 23163;
    packet_in.Angular_Rate_Yaw = 23267;
    packet_in.Quaternion_0 = 493.0;
    packet_in.Quaternion_1 = 521.0;
    packet_in.Quaternion_2 = 549.0;
    packet_in.Quaternion_3 = 577.0;
    packet_in.Telemetry_Status_Mask = 93372036854776815ULL;
    packet_in.Satellite_Num = 231;
...
TEST(AGU_MAVLINK, MOTOR_STATUS_PACK)
{
    ...
    packet_in.Motor_A_Temperature = 19731;
    packet_in.Motor_B_Temperature = 19835;
    packet_in.BMS_Voltage = 19939;
    packet_in.BMS_Absorption = 20043;
    packet_in.BMS_Temperature = 20147;
    packet_in.Motor_Control_Status_Mask = 963499128;
    packet_in.Motor_A_Faults_Mask = 963499336;
    packet_in.Motor_B_Faults_Mask = 963499544;
    packet_in.BMS_Faults_Mask = 963499752;
...
TEST(AGU_MAVLINK, STORAGE_STATUS_PACK)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::AGU_MAVLINK::msg::STORAGE_STATUS_PACK packet_in{};
    packet_in.System_Timestamp = 93372036854775807ULL;
    packet_in.Storage_Free_Data_Size = 963497880;
    packet_in.Storage_Module_Status_Mask = 963498088;

    mavlink::AGU_MAVLINK::msg::STORAGE_STATUS_PACK packet1{};
    mavlink::AGU_MAVLINK::msg::STORAGE_STATUS_PACK packet2{};
    ...
    EXPECT_EQ(packet1.System_Timestamp, packet2.System_Timestamp);
    EXPECT_EQ(packet1.Storage_Free_Data_Size, packet2.Storage_Free_Data_Size);
    EXPECT_EQ(packet1.Storage_Module_Status_Mask, packet2.Storage_Module_Status_Mask);
}

#ifdef TEST_INTEROP
TEST(AGU_MAVLINK_interop, STORAGE_STATUS_PACK)
{
    mavlink_message_t msg;
    ...
    mavlink_storage_status_pack_t packet_c {
    ...
    mavlink_msg_storage_status_pack_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.System_Timestamp, packet2.System_Timestamp);
    EXPECT_EQ(packet_in.Storage_Free_Data_Size, packet2.Storage_Free_Data_Size);
    EXPECT_EQ(packet_in.Storage_Module_Status_Mask, packet2.Storage_Module_Status_Mask);
...
TEST(AGU_MAVLINK, RADIO_LINK_STATUS_PACK)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::AGU_MAVLINK::msg::RADIO_LINK_STATUS_PACK packet_in{};
    packet_in.System_Timestamp = 93372036854775807ULL;
    packet_in.RSSI = 17859;
    packet_in.Radio_Link_Module_Status_Mask = 963497880;

    mavlink::AGU_MAVLINK::msg::RADIO_LINK_STATUS_PACK packet1{};
    mavlink::AGU_MAVLINK::msg::RADIO_LINK_STATUS_PACK packet2{};
...
#ifdef TEST_INTEROP
TEST(AGU_MAVLINK_interop, RADIO_LINK_STATUS_PACK)
{
    mavlink_message_t msg;
    ...
    mavlink_radio_link_status_pack_t packet_c {
    ...
    mavlink_msg_radio_link_status_pack_encode(1, 1, &msg, &packet_c);
...
TEST(AGU_MAVLINK, GUIDANCE_STATUS_PACK)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::AGU_MAVLINK::msg::GUIDANCE_STATUS_PACK packet_in{};
    packet_in.System_Timestamp = 93372036854775807ULL;
    packet_in.Guidance_Module_Status_Mask = 963497880;

    mavlink::AGU_MAVLINK::msg::GUIDANCE_STATUS_PACK packet1{};
    mavlink::AGU_MAVLINK::msg::GUIDANCE_STATUS_PACK packet2{};
...
#ifdef TEST_INTEROP
TEST(AGU_MAVLINK_interop, GUIDANCE_STATUS_PACK)
{
    mavlink_message_t msg;
    ...
    mavlink_guidance_status_pack_t packet_c {
    ...
    mavlink_msg_guidance_status_pack_encode(1, 1, &msg, &packet_c);
