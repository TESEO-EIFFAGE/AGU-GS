...
public:
    ...
    qint32 Longitude() const {return m_Longitude;};
    quint32 GNSSAltitude() const {return m_GNSSAltitude;};
    qint16 AirSpeed_UVector() const {return m_AirSpeed_UVector;};
    qint16 AirSpeed_VVector() const {return m_AirSpeed_VVector;};
    qint16 AirSpeed_WVector() const {return m_AirSpeed_WVector;};
    qint16 AirTemperature() const {return m_AirTemperature;};
    qint32 AltitudeFromRadarAltimeter() const {return m_AltitudeFromRadarAltimeter;};
    qint32 AltitudeFromPayloadAltimeter() const {return m_AltitudeFromPayloadAltimeter;};
    quint16 LinearVelocityHorizontal() const {return m_LinearVelocityHorizontal;};
    qint16 LinearVelocityVertical() const {return m_LinearVelocityVertical;};
    quint16 PositionAccuracy() const {return m_PositionAccuracy;};
    quint16 SpeedAccuracy() const {return m_SpeedAccuracy;};
    qint16 LinearAccelerationX() const {return m_LinearAccelerationX;};
    qint16 LinearAccelerationY() const {return m_LinearAccelerationY;};
    qint16 LinearAccelerationZ() const {return m_LinearAccelerationZ;};
    float ECEFVectorPositionX() const {return m_ECEFVectorPositionX;};
    float ECEFVectorPositionY() const {return m_ECEFVectorPositionY;};
    float ECEFVectorPositionZ() const {return m_ECEFVectorPositionZ;};
    float ECEFVectorVelocityX() const {return m_ECEFVectorVelocityX;};
    float ECEFVectorVelocityY() const {return m_ECEFVectorVelocityY;};
    float ECEFVectorVelocityZ() const {return m_ECEFVectorVelocityZ;};
    qint16 RollAngle() const {return m_RollAngle;};
    qint16 PitchAngle() const {return m_PitchAngle;};
    qint16 YawAngle() const {return m_YawAngle;};
    qint16 AngularRateRoll() const {return m_AngularRateRoll;};
    qint16 AngularRatePitch() const {return m_AngularRatePitch;};
    qint16 AngularRateYaw() const {return m_AngularRateYaw;};
    double Quaternion0() const {return m_Quaternion0;};
    double Quaternion1() const {return m_Quaternion1;};
    double Quaternion2() const {return m_Quaternion2;};
    double Quaternion3() const {return m_Quaternion3;};
    quint8 NumberOfGPSSatellite() const {return m_NumberOfGPSSatellite;};
    quint8 AnemCommErrorCounter() const {return m_AnemCommErrorCounter;};
    quint8 RDAltCommErrorCounter() const {return m_RDAltCommErrorCounter;};
    quint8 GNSSCommErrorCounter() const {return m_GNSSCommErrorCounter;};
    quint8 PLAltCommErrorCounter() const {return m_PLAltCommErrorCounter;};
    bool telemetry0() const {return m_telemetry0;};
    bool telemetry1() const {return m_telemetry1;};
    bool telemetry2() const {return m_telemetry2;};
    bool telemetry3() const {return m_telemetry3;};
    bool telemetry4() const {return m_telemetry4;};
    bool telemetry5() const {return m_telemetry5;};
    bool telemetry6() const {return m_telemetry6;};
    bool telemetry7() const {return m_telemetry7;};
    bool telemetry8() const {return m_telemetry8;};
    bool telemetry9() const {return m_telemetry9;};
    bool telemetry10() const {return m_telemetry10;};
    bool telemetry11() const {return m_telemetry11;};
    bool telemetry12() const {return m_telemetry12;};
    bool telemetry13() const {return m_telemetry13;};
    bool telemetry14() const {return m_telemetry14;};
    bool telemetry15() const {return m_telemetry15;};
    bool telemetry16() const {return m_telemetry16;};
    bool telemetry17() const {return m_telemetry17;};
    bool telemetry18() const {return m_telemetry18;};
    bool telemetry19() const {return m_telemetry19;};
    bool telemetry20() const {return m_telemetry20;};
    bool telemetry21() const {return m_telemetry21;};
    bool telemetry22() const {return m_telemetry22;};
    bool telemetry23() const {return m_telemetry23;};
    bool telemetry24() const {return m_telemetry24;};
    bool telemetry25() const {return m_telemetry25;};
    bool telemetry26() const {return m_telemetry26;};
    bool telemetry27() const {return m_telemetry27;};
    bool telemetry28() const {return m_telemetry28;};
    bool telemetry29() const {return m_telemetry29;};
    bool telemetry30() const {return m_telemetry30;};
    bool telemetry31() const {return m_telemetry31;};

    int telemetryMsgCounter() const {return m_telemetryMsgCounter;};

    /* MOTOR */


    qint32 MotorARealPosition() const {return m_MotorARealPosition;};
    qint32 MotorADemandPosition() const {return m_MotorADemandPosition;};
    qint32 MotorATorque() const {return m_MotorATorque;};
    qint16 MotorATemp() const {return m_MotorATemp;};

    qint32 MotorBRealPosition() const {return m_MotorBRealPosition;};
    qint32 MotorBDemandPosition() const {return m_MotorBDemandPosition;};
    qint32 MotorBTorque() const {return m_MotorBTorque;};
    qint16 MotorBTemp() const {return m_MotorBTemp;};

    quint16 BMSVoltage() const {return m_BMSVoltage;};
    qint16 BMSAbsorption() const {return m_BMSAbsorption;};
    qint16 BMSTemp() const {return m_BMSTemp;};

    quint32 MotorAFaultsMask() const {return m_MotorAFaultsMask;};
    quint32 MotorBFaultsMask() const {return m_MotorBFaultsMask;};
    quint32 BMSFaultsMask() const {return m_BMSFaultsMask;};

    quint8 ChargeValue() const {return m_ChargeValue;};

    bool motor0() const {return m_motor0;};
    bool motor1() const {return m_motor1;};
    bool motor2() const {return m_motor2;};
    bool motor3() const {return m_motor3;};
    bool motor4() const {return m_motor4;};
    bool motor5() const {return m_motor5;};
    bool motor6() const {return m_motor6;};
    bool motor7() const {return m_motor7;};
    bool motor8() const {return m_motor8;};
    bool motor10() const {return m_motor10;};
    bool motor11() const {return m_motor11;};
    bool motor12() const {return m_motor12;};
    bool motor13() const {return m_motor13;};
    bool motor14() const {return m_motor14;};
    bool motor15() const {return m_motor15;};
    bool motor16() const {return m_motor16;};
    bool motor17() const {return m_motor17;};
    bool motor18() const {return m_motor18;};
    bool motor19() const {return m_motor19;};
    bool motor20() const {return m_motor20;};
    bool motor21() const {return m_motor21;};
    bool motor22() const {return m_motor22;};
    bool motor23() const {return m_motor23;};
    bool motor24() const {return m_motor24;};

    bool motorAMask0() const {return m_motorAMask0;};
    bool motorAMask1() const {return m_motorAMask1;};
    bool motorAMask2() const {return m_motorAMask2;};
    bool motorAMask3() const {return m_motorAMask3;};
    bool motorAMask4() const {return m_motorAMask4;};
    bool motorAMask5() const {return m_motorAMask5;};
    bool motorAMask6() const {return m_motorAMask6;};
    bool motorAMask7() const {return m_motorAMask7;};
    bool motorAMask8() const {return m_motorAMask8;};
    bool motorAMask9() const {return m_motorAMask9;};
    bool motorAMask10() const {return m_motorAMask10;};
    bool motorAMask11() const {return m_motorAMask11;};
    bool motorAMask12() const {return m_motorAMask12;};
    bool motorAMask13() const {return m_motorAMask13;};
    bool motorAMask14() const {return m_motorAMask14;};
    bool motorAMask15() const {return m_motorAMask15;};
    bool motorAMask16() const {return m_motorAMask16;};
    bool motorAMask17() const {return m_motorAMask17;};
    bool motorAMask18() const {return m_motorAMask18;};
    bool motorAMask19() const {return m_motorAMask19;};
    bool motorAMask20() const {return m_motorAMask20;};
    bool motorAMask21() const {return m_motorAMask21;};
    bool motorAMask22() const {return m_motorAMask22;};
    bool motorAMask23() const {return m_motorAMask23;};
    bool motorAMask24() const {return m_motorAMask24;};
    bool motorAMask25() const {return m_motorAMask25;};
    bool motorAMask26() const {return m_motorAMask26;};
    bool motorAMask27() const {return m_motorAMask27;};
    bool motorAMask28() const {return m_motorAMask28;};
    bool motorAMask29() const {return m_motorAMask29;};
    bool motorAMask30() const {return m_motorAMask30;};
    bool motorAMask31() const {return m_motorAMask31;};

    bool motorBMask0() const {return m_motorBMask0;};
    bool motorBMask1() const {return m_motorBMask1;};
    bool motorBMask2() const {return m_motorBMask2;};
    bool motorBMask3() const {return m_motorBMask3;};
    bool motorBMask4() const {return m_motorBMask4;};
    bool motorBMask5() const {return m_motorBMask5;};
    bool motorBMask6() const {return m_motorBMask6;};
    bool motorBMask7() const {return m_motorBMask7;};
    bool motorBMask8() const {return m_motorBMask8;};
    bool motorBMask9() const {return m_motorBMask9;};
    bool motorBMask10() const {return m_motorBMask10;};
    bool motorBMask11() const {return m_motorBMask11;};
    bool motorBMask12() const {return m_motorBMask12;};
    bool motorBMask13() const {return m_motorBMask13;};
    bool motorBMask14() const {return m_motorBMask14;};
    bool motorBMask15() const {return m_motorBMask15;};
    bool motorBMask16() const {return m_motorBMask16;};
    bool motorBMask17() const {return m_motorBMask17;};
    bool motorBMask18() const {return m_motorBMask18;};
    bool motorBMask19() const {return m_motorBMask19;};
    bool motorBMask20() const {return m_motorBMask20;};
    bool motorBMask21() const {return m_motorBMask21;};
    bool motorBMask22() const {return m_motorBMask22;};
    bool motorBMask23() const {return m_motorBMask23;};
    bool motorBMask24() const {return m_motorBMask24;};
    bool motorBMask25() const {return m_motorBMask25;};
    bool motorBMask26() const {return m_motorBMask26;};
    bool motorBMask27() const {return m_motorBMask27;};
    bool motorBMask28() const {return m_motorBMask28;};
    bool motorBMask29() const {return m_motorBMask29;};
    bool motorBMask30() const {return m_motorBMask30;};
    bool motorBMask31() const {return m_motorBMask31;};

    bool BMS0() const {return m_BMS0;};
    bool BMS1() const {return m_BMS1;};
    bool BMS2() const {return m_BMS2;};
    bool BMS3() const {return m_BMS3;};
    bool BMS4() const {return m_BMS4;};
    bool BMS5() const {return m_BMS5;};
    bool BMS6() const {return m_BMS6;};
    bool BMS7() const {return m_BMS7;};
    bool BMS8() const {return m_BMS8;};
    bool BMS9() const {return m_BMS9;};
    bool BMS10() const {return m_BMS10;};
    bool BMS11() const {return m_BMS11;};
    bool BMS12() const {return m_BMS12;};
    bool BMS13() const {return m_BMS13;};
    bool BMS14() const {return m_BMS14;};
    bool BMS15() const {return m_BMS15;};
    bool BMS16() const {return m_BMS16;};
    bool BMS17() const {return m_BMS17;};
    bool BMS18() const {return m_BMS18;};
    bool BMS19() const {return m_BMS19;};
    bool BMS20() const {return m_BMS20;};
    bool BMS21() const {return m_BMS21;};
    bool BMS22() const {return m_BMS22;};
    bool BMS23() const {return m_BMS23;};
    bool BMS24() const {return m_BMS24;};
    bool BMS25() const {return m_BMS25;};
    bool BMS26() const {return m_BMS26;};
    bool BMS27() const {return m_BMS27;};
    bool BMS28() const {return m_BMS28;};
    bool BMS29() const {return m_BMS29;};
    bool BMS30() const {return m_BMS30;};
    bool BMS31() const {return m_BMS31;};

    int motorMsgCounter() const {return m_motorMsgCounter;};

    /* SYSTEM */

    quint8 FlightMode() const {return m_FlightMode;};
    quint8 FlightPhase() const {return m_FlightPhase;};
    quint32 FlightPhaseExecutionTime() const {return m_FlightPhaseExecutionTime;};
    quint32 CoreModuleStatusMask() const {return m_CoreModuleStatusMask;};
    quint64 TelemetryModuleStatusMask() const {return m_TelemetryModuleStatusMask;};
    quint32 GuidanceModuleStatusMask() const {return m_GuidanceModuleStatusMask;};
    quint32 StorageModuleStatusMask() const {return m_StorageModuleStatusMask;};
    quint32 RadioLinkModuleStatusMask() const {return m_RadioLinkModuleStatusMask;};
    quint32 MotorControlStatusMask() const {return m_MotorControlStatusMask;};

    quint8 communicationErrorCounter() const {return m_communicationErrorCounter;};
    bool systemCoreMask0() const {return m_systemCoreMask0;};
    bool systemCoreMask1() const {return m_systemCoreMask1;};
    bool systemCoreMask2() const {return m_systemCoreMask2;};
    bool systemCoreMask3() const {return m_systemCoreMask3;};
    bool systemCoreMask4() const {return m_systemCoreMask4;};
    bool systemCoreMask5() const {return m_systemCoreMask5;};
    bool systemCoreMask6() const {return m_systemCoreMask6;};
    bool systemCoreMask7() const {return m_systemCoreMask7;};
    bool systemCoreMask8() const {return m_systemCoreMask8;};
    bool systemCoreMask9() const {return m_systemCoreMask9;};
    bool systemCoreMask10() const {return m_systemCoreMask10;};
    bool systemCoreMask11() const {return m_systemCoreMask11;};
    bool systemCoreMask12() const {return m_systemCoreMask12;};
    bool systemCoreMask13() const {return m_systemCoreMask13;};
    bool systemCoreMask14() const {return m_systemCoreMask14;};
    bool systemCoreMask15() const {return m_systemCoreMask15;};
    bool systemCoreMask16() const {return m_systemCoreMask16;};
    bool systemCoreMask17() const {return m_systemCoreMask17;};
    bool systemCoreMask18() const {return m_systemCoreMask18;};
    bool systemCoreMask19() const {return m_systemCoreMask19;};
    bool systemCoreMask20() const {return m_systemCoreMask20;};
    bool systemCoreMask21() const {return m_systemCoreMask21;};
    bool systemCoreMask22() const {return m_systemCoreMask22;};
    bool systemCoreMask23() const {return m_systemCoreMask23;};
    bool systemCoreMask24() const {return m_systemCoreMask24;};
    bool systemCoreMask25() const {return m_systemCoreMask25;};
    bool systemCoreMask26() const {return m_systemCoreMask26;};
    bool systemCoreMask27() const {return m_systemCoreMask27;};
    bool systemCoreMask28() const {return m_systemCoreMask28;};
    bool systemCoreMask29() const {return m_systemCoreMask29;};
    bool systemCoreMask30() const {return m_systemCoreMask30;};
    bool systemCoreMask31() const {return m_systemCoreMask31;};

    bool systemStorageMask0() const {return m_systemStorageMask0;};
    bool systemStorageMask1() const {return m_systemStorageMask1;};
    bool systemStorageMask2() const {return m_systemStorageMask2;};
    bool systemStorageMask3() const {return m_systemStorageMask3;};
    bool systemStorageMask4() const {return m_systemStorageMask4;};
    bool systemStorageMask5() const {return m_systemStorageMask5;};
    bool systemStorageMask6() const {return m_systemStorageMask6;};
    bool systemStorageMask7() const {return m_systemStorageMask7;};
    bool systemStorageMask8() const {return m_systemStorageMask8;};
    bool systemStorageMask9() const {return m_systemStorageMask9;};
    bool systemStorageMask10() const {return m_systemStorageMask10;};
    bool systemStorageMask11() const {return m_systemStorageMask11;};
    bool systemStorageMask12() const {return m_systemStorageMask12;};
    bool systemStorageMask13() const {return m_systemStorageMask13;};
    bool systemStorageMask14() const {return m_systemStorageMask14;};
    bool systemStorageMask15() const {return m_systemStorageMask15;};
    bool systemStorageMask16() const {return m_systemStorageMask16;};
    bool systemStorageMask17() const {return m_systemStorageMask17;};
    bool systemStorageMask18() const {return m_systemStorageMask18;};
    bool systemStorageMask19() const {return m_systemStorageMask19;};
    bool systemStorageMask20() const {return m_systemStorageMask20;};
    bool systemStorageMask21() const {return m_systemStorageMask21;};
    bool systemStorageMask22() const {return m_systemStorageMask22;};
    bool systemStorageMask23() const {return m_systemStorageMask23;};
    bool systemStorageMask24() const {return m_systemStorageMask24;};
    bool systemStorageMask25() const {return m_systemStorageMask25;};
    bool systemStorageMask26() const {return m_systemStorageMask26;};
    bool systemStorageMask27() const {return m_systemStorageMask27;};
    bool systemStorageMask28() const {return m_systemStorageMask28;};
    bool systemStorageMask29() const {return m_systemStorageMask29;};
    bool systemStorageMask30() const {return m_systemStorageMask30;};
    bool systemStorageMask31() const {return m_systemStorageMask31;};

    bool systemGuidanceMask0() const {return m_systemGuidanceMask0;};
    bool systemGuidanceMask1() const {return m_systemGuidanceMask1;};
    bool systemGuidanceMask2() const {return m_systemGuidanceMask2;};
    bool systemGuidanceMask3() const {return m_systemGuidanceMask3;};
    bool systemGuidanceMask4() const {return m_systemGuidanceMask4;};
    bool systemGuidanceMask5() const {return m_systemGuidanceMask5;};
    bool systemGuidanceMask6() const {return m_systemGuidanceMask6;};
    bool systemGuidanceMask7() const {return m_systemGuidanceMask7;};
    bool systemGuidanceMask8() const {return m_systemGuidanceMask8;};
    bool systemGuidanceMask9() const {return m_systemGuidanceMask9;};
    bool systemGuidanceMask10() const {return m_systemGuidanceMask10;};
    bool systemGuidanceMask11() const {return m_systemGuidanceMask11;};
    bool systemGuidanceMask12() const {return m_systemGuidanceMask12;};
    bool systemGuidanceMask13() const {return m_systemGuidanceMask13;};
    bool systemGuidanceMask14() const {return m_systemGuidanceMask14;};
    bool systemGuidanceMask15() const {return m_systemGuidanceMask15;};
    bool systemGuidanceMask16() const {return m_systemGuidanceMask16;};
    bool systemGuidanceMask17() const {return m_systemGuidanceMask17;};
    bool systemGuidanceMask18() const {return m_systemGuidanceMask18;};
    bool systemGuidanceMask19() const {return m_systemGuidanceMask19;};
    bool systemGuidanceMask20() const {return m_systemGuidanceMask20;};
    bool systemGuidanceMask21() const {return m_systemGuidanceMask21;};
    bool systemGuidanceMask22() const {return m_systemGuidanceMask22;};
    bool systemGuidanceMask23() const {return m_systemGuidanceMask23;};
    bool systemGuidanceMask24() const {return m_systemGuidanceMask24;};
    bool systemGuidanceMask25() const {return m_systemGuidanceMask25;};
    bool systemGuidanceMask26() const {return m_systemGuidanceMask26;};
    bool systemGuidanceMask27() const {return m_systemGuidanceMask27;};
    bool systemGuidanceMask28() const {return m_systemGuidanceMask28;};
    bool systemGuidanceMask29() const {return m_systemGuidanceMask29;};
    bool systemGuidanceMask30() const {return m_systemGuidanceMask30;};
    bool systemGuidanceMask31() const {return m_systemGuidanceMask31;};

    bool systemMotorControlMask0() const {return m_systemMotorControlMask0;};
    bool systemMotorControlMask1() const {return m_systemMotorControlMask1;};
    bool systemMotorControlMask2() const {return m_systemMotorControlMask2;};
    bool systemMotorControlMask3() const {return m_systemMotorControlMask3;};
    bool systemMotorControlMask4() const {return m_systemMotorControlMask4;};
    bool systemMotorControlMask5() const {return m_systemMotorControlMask5;};
    bool systemMotorControlMask6() const {return m_systemMotorControlMask6;};
    bool systemMotorControlMask7() const {return m_systemMotorControlMask7;};
    bool systemMotorControlMask8() const {return m_systemMotorControlMask8;};
    bool systemMotorControlMask9() const {return m_systemMotorControlMask9;};
    bool systemMotorControlMask10() const {return m_systemMotorControlMask10;};
    bool systemMotorControlMask11() const {return m_systemMotorControlMask11;};
    bool systemMotorControlMask12() const {return m_systemMotorControlMask12;};
    bool systemMotorControlMask13() const {return m_systemMotorControlMask13;};
    bool systemMotorControlMask14() const {return m_systemMotorControlMask14;};
    bool systemMotorControlMask15() const {return m_systemMotorControlMask15;};
    bool systemMotorControlMask16() const {return m_systemMotorControlMask16;};
    bool systemMotorControlMask17() const {return m_systemMotorControlMask17;};
    bool systemMotorControlMask18() const {return m_systemMotorControlMask18;};
    bool systemMotorControlMask19() const {return m_systemMotorControlMask19;};
    bool systemMotorControlMask20() const {return m_systemMotorControlMask20;};
    bool systemMotorControlMask21() const {return m_systemMotorControlMask21;};
    bool systemMotorControlMask22() const {return m_systemMotorControlMask22;};
    bool systemMotorControlMask23() const {return m_systemMotorControlMask23;};
    bool systemMotorControlMask24() const {return m_systemMotorControlMask24;};
    bool systemMotorControlMask25() const {return m_systemMotorControlMask25;};
    bool systemMotorControlMask26() const {return m_systemMotorControlMask26;};
    bool systemMotorControlMask27() const {return m_systemMotorControlMask27;};
    bool systemMotorControlMask28() const {return m_systemMotorControlMask28;};
    bool systemMotorControlMask29() const {return m_systemMotorControlMask29;};
    bool systemMotorControlMask30() const {return m_systemMotorControlMask30;};
    bool systemMotorControlMask31() const {return m_systemMotorControlMask31;};


    bool systemTelemetryMask0() const {return m_systemTelemetryMask0;};
    bool systemTelemetryMask1() const {return m_systemTelemetryMask1;};
    bool systemTelemetryMask2() const {return m_systemTelemetryMask2;};
    bool systemTelemetryMask3() const {return m_systemTelemetryMask3;};
    bool systemTelemetryMask4() const {return m_systemTelemetryMask4;};
    bool systemTelemetryMask5() const {return m_systemTelemetryMask5;};
    bool systemTelemetryMask6() const {return m_systemTelemetryMask6;};
    bool systemTelemetryMask7() const {return m_systemTelemetryMask7;};
    bool systemTelemetryMask8() const {return m_systemTelemetryMask8;};
    bool systemTelemetryMask9() const {return m_systemTelemetryMask9;};
    bool systemTelemetryMask10() const {return m_systemTelemetryMask10;};
    bool systemTelemetryMask11() const {return m_systemTelemetryMask11;};
    bool systemTelemetryMask12() const {return m_systemTelemetryMask12;};
    bool systemTelemetryMask13() const {return m_systemTelemetryMask13;};
    bool systemTelemetryMask14() const {return m_systemTelemetryMask14;};
    bool systemTelemetryMask15() const {return m_systemTelemetryMask15;};
    bool systemTelemetryMask16() const {return m_systemTelemetryMask16;};
    bool systemTelemetryMask17() const {return m_systemTelemetryMask17;};
    bool systemTelemetryMask18() const {return m_systemTelemetryMask18;};
    bool systemTelemetryMask19() const {return m_systemTelemetryMask19;};
    bool systemTelemetryMask20() const {return m_systemTelemetryMask20;};
    bool systemTelemetryMask21() const {return m_systemTelemetryMask21;};
    bool systemTelemetryMask22() const {return m_systemTelemetryMask22;};
    bool systemTelemetryMask23() const {return m_systemTelemetryMask23;};
    bool systemTelemetryMask24() const {return m_systemTelemetryMask24;};
    bool systemTelemetryMask25() const {return m_systemTelemetryMask25;};
    bool systemTelemetryMask26() const {return m_systemTelemetryMask26;};
    bool systemTelemetryMask27() const {return m_systemTelemetryMask27;};
    bool systemTelemetryMask28() const {return m_systemTelemetryMask28;};
    bool systemTelemetryMask29() const {return m_systemTelemetryMask29;};
    bool systemTelemetryMask30() const {return m_systemTelemetryMask30;};
    bool systemTelemetryMask31() const {return m_systemTelemetryMask31;};
    bool systemTelemetryMask32() const {return m_systemTelemetryMask32;};
    bool systemTelemetryMask33() const {return m_systemTelemetryMask33;};
    bool systemTelemetryMask34() const {return m_systemTelemetryMask34;};
    bool systemTelemetryMask35() const {return m_systemTelemetryMask35;};
    bool systemTelemetryMask36() const {return m_systemTelemetryMask36;};
    bool systemTelemetryMask37() const {return m_systemTelemetryMask37;};
    bool systemTelemetryMask38() const {return m_systemTelemetryMask38;};
    bool systemTelemetryMask39() const {return m_systemTelemetryMask39;};
    bool systemTelemetryMask40() const {return m_systemTelemetryMask40;};
    bool systemTelemetryMask41() const {return m_systemTelemetryMask41;};
    bool systemTelemetryMask42() const {return m_systemTelemetryMask42;};
    bool systemTelemetryMask43() const {return m_systemTelemetryMask43;};
    bool systemTelemetryMask44() const {return m_systemTelemetryMask44;};
    bool systemTelemetryMask45() const {return m_systemTelemetryMask45;};
    bool systemTelemetryMask46() const {return m_systemTelemetryMask46;};
    bool systemTelemetryMask47() const {return m_systemTelemetryMask47;};
    bool systemTelemetryMask48() const {return m_systemTelemetryMask48;};
    bool systemTelemetryMask49() const {return m_systemTelemetryMask49;};
    bool systemTelemetryMask50() const {return m_systemTelemetryMask50;};
    bool systemTelemetryMask51() const {return m_systemTelemetryMask51;};
    bool systemTelemetryMask52() const {return m_systemTelemetryMask52;};
    bool systemTelemetryMask53() const {return m_systemTelemetryMask53;};
    bool systemTelemetryMask54() const {return m_systemTelemetryMask54;};
    bool systemTelemetryMask55() const {return m_systemTelemetryMask55;};
    bool systemTelemetryMask56() const {return m_systemTelemetryMask56;};
    bool systemTelemetryMask57() const {return m_systemTelemetryMask57;};
    bool systemTelemetryMask58() const {return m_systemTelemetryMask58;};
    bool systemTelemetryMask59() const {return m_systemTelemetryMask59;};
    bool systemTelemetryMask60() const {return m_systemTelemetryMask60;};
    bool systemTelemetryMask61() const {return m_systemTelemetryMask61;};
    bool systemTelemetryMask62() const {return m_systemTelemetryMask62;};
    bool systemTelemetryMask63() const {return m_systemTelemetryMask63;};

    bool emergencyBoardStatus0() const {return m_emergencyBoardStatus0;};
    bool emergencyBoardStatus1() const {return m_emergencyBoardStatus1;};
    bool emergencyBoardStatus2() const {return m_emergencyBoardStatus2;};
    bool emergencyBoardStatus3() const {return m_emergencyBoardStatus3;};
    bool emergencyBoardStatus4() const {return m_emergencyBoardStatus4;};
    bool emergencyBoardStatus5() const {return m_emergencyBoardStatus5;};
    bool emergencyBoardStatus6() const {return m_emergencyBoardStatus6;};
    bool emergencyBoardStatus7() const {return m_emergencyBoardStatus7;};
    bool emergencyBoardStatus8() const {return m_emergencyBoardStatus8;};
    bool emergencyBoardStatus9() const {return m_emergencyBoardStatus9;};
    bool emergencyBoardStatus10() const {return m_emergencyBoardStatus10;};
    bool emergencyBoardStatus11() const {return m_emergencyBoardStatus11;};
    bool emergencyBoardStatus12() const {return m_emergencyBoardStatus12;};
    bool emergencyBoardStatus13() const {return m_emergencyBoardStatus13;};
    bool emergencyBoardStatus14() const {return m_emergencyBoardStatus14;};
    bool emergencyBoardStatus15() const {return m_emergencyBoardStatus15;};

    bool PSUStatus0() const {return m_PSUStatus0;};
    bool PSUStatus1() const {return m_PSUStatus1;};
    bool PSUStatus2() const {return m_PSUStatus2;};
    bool PSUStatus3() const {return m_PSUStatus3;};
    bool PSUStatus4() const {return m_PSUStatus4;};
    bool PSUStatus5() const {return m_PSUStatus5;};
    bool PSUStatus6() const {return m_PSUStatus6;};
    bool PSUStatus7() const {return m_PSUStatus7;};
    bool PSUStatus8() const {return m_PSUStatus8;};
    bool PSUStatus9() const {return m_PSUStatus9;};
    bool PSUStatus10() const {return m_PSUStatus10;};
    bool PSUStatus11() const {return m_PSUStatus11;};
    bool PSUStatus12() const {return m_PSUStatus12;};
    bool PSUStatus13() const {return m_PSUStatus13;};
    bool PSUStatus14() const {return m_PSUStatus14;};
    bool PSUStatus15() const {return m_PSUStatus15;};

    bool emergencyRadioLinkStatus0() const {return m_emergencyRadioLinkStatus0;};
    bool emergencyRadioLinkStatus1() const {return m_emergencyRadioLinkStatus1;};
    bool emergencyRadioLinkStatus2() const {return m_emergencyRadioLinkStatus2;};
    bool emergencyRadioLinkStatus3() const {return m_emergencyRadioLinkStatus3;};
    bool emergencyRadioLinkStatus4() const {return m_emergencyRadioLinkStatus4;};
    bool emergencyRadioLinkStatus5() const {return m_emergencyRadioLinkStatus5;};
    bool emergencyRadioLinkStatus6() const {return m_emergencyRadioLinkStatus6;};
    bool emergencyRadioLinkStatus7() const {return m_emergencyRadioLinkStatus7;};

    int systemMsgCounter() const {return m_systemMsgCounter;};


    /* RADIOLINK */

    quint16 RSSI() const {return m_RSSI;};
    quint8 radiolinkErrorCounter() const {return m_radiolinkErrorCounter;};
    bool radiolinkMask0() const {return m_radiolinkMask0;};
    bool radiolinkMask1() const {return m_radiolinkMask1;};
    bool radiolinkMask2() const {return m_radiolinkMask2;};
    bool radiolinkMask3() const {return m_radiolinkMask3;};
    bool radiolinkMask4() const {return m_radiolinkMask4;};
    bool radiolinkMask5() const {return m_radiolinkMask5;};
    bool radiolinkMask6() const {return m_radiolinkMask6;};
    bool radiolinkMask7() const {return m_radiolinkMask7;};
    bool radiolinkMask8() const {return m_radiolinkMask8;};
    bool radiolinkMask9() const {return m_radiolinkMask9;};
    bool radiolinkMask10() const {return m_radiolinkMask10;};
    bool radiolinkMask11() const {return m_radiolinkMask11;};
    bool radiolinkMask12() const {return m_radiolinkMask12;};
    bool radiolinkMask13() const {return m_radiolinkMask13;};
    bool radiolinkMask14() const {return m_radiolinkMask14;};
    bool radiolinkMask15() const {return m_radiolinkMask15;};
    bool radiolinkMask16() const {return m_radiolinkMask16;};
    bool radiolinkMask17() const {return m_radiolinkMask17;};
    bool radiolinkMask18() const {return m_radiolinkMask18;};
    bool radiolinkMask19() const {return m_radiolinkMask19;};
    bool radiolinkMask20() const {return m_radiolinkMask20;};
    bool radiolinkMask21() const {return m_radiolinkMask21;};
    bool radiolinkMask22() const {return m_radiolinkMask22;};
    bool radiolinkMask23() const {return m_radiolinkMask23;};
    bool radiolinkMask24() const {return m_radiolinkMask24;};
    bool radiolinkMask25() const {return m_radiolinkMask25;};
    bool radiolinkMask26() const {return m_radiolinkMask26;};
    bool radiolinkMask27() const {return m_radiolinkMask27;};
    bool radiolinkMask28() const {return m_radiolinkMask28;};
    bool radiolinkMask29() const {return m_radiolinkMask29;};
    bool radiolinkMask30() const {return m_radiolinkMask30;};
    bool radiolinkMask31() const {return m_radiolinkMask31;};

    int radiolinkMsgCounter() const {return m_radiolinkMsgCounter;};


    /* GUIDANCE */

    bool guidanceMask0() const {return m_guidanceMask0;};
    bool guidanceMask1() const {return m_guidanceMask1;};
    bool guidanceMask2() const {return m_guidanceMask2;};
    bool guidanceMask3() const {return m_guidanceMask3;};
    bool guidanceMask4() const {return m_guidanceMask4;};
    bool guidanceMask5() const {return m_guidanceMask5;};
    bool guidanceMask6() const {return m_guidanceMask6;};
    bool guidanceMask7() const {return m_guidanceMask7;};
    bool guidanceMask8() const {return m_guidanceMask8;};
    bool guidanceMask9() const {return m_guidanceMask9;};
    bool guidanceMask10() const {return m_guidanceMask10;};
    bool guidanceMask11() const {return m_guidanceMask11;};
    bool guidanceMask12() const {return m_guidanceMask12;};
    bool guidanceMask13() const {return m_guidanceMask13;};
    bool guidanceMask14() const {return m_guidanceMask14;};
    bool guidanceMask15() const {return m_guidanceMask15;};
    bool guidanceMask16() const {return m_guidanceMask16;};
    bool guidanceMask17() const {return m_guidanceMask17;};
    bool guidanceMask18() const {return m_guidanceMask18;};
    bool guidanceMask19() const {return m_guidanceMask19;};
    bool guidanceMask20() const {return m_guidanceMask20;};
    bool guidanceMask21() const {return m_guidanceMask21;};
    bool guidanceMask22() const {return m_guidanceMask22;};
    bool guidanceMask23() const {return m_guidanceMask23;};
    bool guidanceMask24() const {return m_guidanceMask24;};
    bool guidanceMask25() const {return m_guidanceMask25;};
    bool guidanceMask26() const {return m_guidanceMask26;};
    bool guidanceMask27() const {return m_guidanceMask27;};
    bool guidanceMask28() const {return m_guidanceMask28;};
    bool guidanceMask29() const {return m_guidanceMask29;};
    bool guidanceMask30() const {return m_guidanceMask30;};
    bool guidanceMask31() const {return m_guidanceMask31;};

    int guidanceMsgCounter() const {return m_guidanceMsgCounter;};

    /* STORAGE */

    quint32 storageFreeDataSize() const {return m_storageFreeDataSize;};
    bool storage0() const {return m_storage0;};
    bool storage1() const {return m_storage1;};
    bool storage2() const {return m_storage2;};
    bool storage3() const {return m_storage3;};
    bool storage4() const {return m_storage4;};
    bool storage5() const {return m_storage5;};
    bool storage6() const {return m_storage6;};
    bool storage7() const {return m_storage7;};
    bool storage8() const {return m_storage8;};
    bool storage9() const {return m_storage9;};
    bool storage10() const {return m_storage10;};
    bool storage11() const {return m_storage11;};
    bool storage12() const {return m_storage12;};
    bool storage13() const {return m_storage13;};
    bool storage14() const {return m_storage14;};
    bool storage15() const {return m_storage15;};
    bool storage16() const {return m_storage16;};
    bool storage17() const {return m_storage17;};
    bool storage18() const {return m_storage18;};
    bool storage19() const {return m_storage19;};
    bool storage20() const {return m_storage20;};
    bool storage21() const {return m_storage21;};
    bool storage22() const {return m_storage22;};
    bool storage23() const {return m_storage23;};
    bool storage24() const {return m_storage24;};
    bool storage25() const {return m_storage25;};
    bool storage26() const {return m_storage26;};
    bool storage27() const {return m_storage27;};
    bool storage28() const {return m_storage28;};
    bool storage29() const {return m_storage29;};
    bool storage30() const {return m_storage30;};
    bool storage31() const {return m_storage31;};

    int storageMsgCounter() const {return m_storageMsgCounter;};

    bool msgTelemetryOld() const {return m_msgTelemetryOld;};
    bool msgGuidanceOld() const {return m_msgGuidanceOld;};
    bool msgStorageOld() const {return m_msgStorageOld;};
    bool msgSystemOld() const {return m_msgSystemOld;};
    bool msgRadioLinkOld() const {return m_msgRadioLinkOld;};
    bool msgMotorOld() const {return m_msgMotorOld;};
    ...
    /* TBD */
    quint8 GSRLErrorCounter() const {return m_GSRLErrorCounter;};
    quint8 FSRLErrorCounter() const {return m_FSRLErrorCounter;};
    quint8 RLHeartbeatCounter() const {return m_RLHeartbeatCounter;};
    bool gnssFound() const {return m_gnssFound;};



public slots:
    void setLongitude(qint32 Longitude) {m_Longitude=Longitude;emit LongitudeChanged();};
    void setGNSSAltitude(quint32 GNSSAltitude) {m_GNSSAltitude=GNSSAltitude;emit GNSSAltitudeChanged();};
    void setAirSpeed_UVector(qint16 AirSpeed_UVector) {m_AirSpeed_UVector=AirSpeed_UVector;emit AirSpeed_UVectorChanged();};
    void setAirSpeed_VVector(qint16 AirSpeed_VVector) {m_AirSpeed_VVector=AirSpeed_VVector;emit AirSpeed_VVectorChanged();};
    void setAirSpeed_WVector(qint16 AirSpeed_WVector) {m_AirSpeed_WVector=AirSpeed_WVector;emit AirSpeed_WVectorChanged();};
    void setAirTemperature(qint16 AirTemperature) {m_AirTemperature=AirTemperature;emit AirTemperatureChanged();};
    void setAltitudeFromRadarAltimeter(qint32 AltitudeFromRadarAltimeter) {m_AltitudeFromRadarAltimeter=AltitudeFromRadarAltimeter;emit AltitudeFromRadarAltimeterChanged();};
    void setAltitudeFromPayloadAltimeter(qint32 AltitudeFromPayloadAltimeter) {m_AltitudeFromPayloadAltimeter=AltitudeFromPayloadAltimeter;emit AltitudeFromPayloadAltimeterChanged();};
    void setLinearVelocityHorizontal(quint16 LinearVelocityHorizontal) {m_LinearVelocityHorizontal=LinearVelocityHorizontal;emit LinearVelocityHorizontalChanged();};
    void setLinearVelocityVertical(qint16 LinearVelocityVertical) {m_LinearVelocityVertical=LinearVelocityVertical;emit LinearVelocityVerticalChanged();};
    void setPositionAccuracy(quint16 PositionAccuracy) {m_PositionAccuracy=PositionAccuracy;emit PositionAccuracyChanged();};
    void setSpeedAccuracy(quint16 SpeedAccuracy) {m_SpeedAccuracy=SpeedAccuracy;emit SpeedAccuracyChanged();};
    void setLinearAccelerationX(qint16 LinearAccelerationX) {m_LinearAccelerationX=LinearAccelerationX;emit LinearAccelerationXChanged();};
    void setLinearAccelerationY(qint16 LinearAccelerationY) {m_LinearAccelerationY=LinearAccelerationY;emit LinearAccelerationYChanged();};
    void setLinearAccelerationZ(qint16 LinearAccelerationZ) {m_LinearAccelerationZ=LinearAccelerationZ;emit LinearAccelerationZChanged();};
    void setECEFVectorPositionX(float ECEFVectorPositionX) {m_ECEFVectorPositionX=ECEFVectorPositionX;emit ECEFVectorPositionXChanged();};
    void setECEFVectorPositionY(float ECEFVectorPositionY) {m_ECEFVectorPositionY=ECEFVectorPositionY;emit ECEFVectorPositionYChanged();};
    void setECEFVectorPositionZ(float ECEFVectorPositionZ) {m_ECEFVectorPositionZ=ECEFVectorPositionZ;emit ECEFVectorPositionZChanged();};
    void setECEFVectorVelocityX(float ECEFVectorVelocityX) {m_ECEFVectorVelocityX=ECEFVectorVelocityX;emit ECEFVectorVelocityXChanged();};
    void setECEFVectorVelocityY(float ECEFVectorVelocityY) {m_ECEFVectorVelocityY=ECEFVectorVelocityY;emit ECEFVectorVelocityYChanged();};
    void setECEFVectorVelocityZ(float ECEFVectorVelocityZ) {m_ECEFVectorVelocityZ=ECEFVectorVelocityZ;emit ECEFVectorVelocityZChanged();};
    void setRollAngle(qint16 RollAngle) {m_RollAngle=RollAngle;emit RollAngleChanged();};
    void setPitchAngle(qint16 PitchAngle) {m_PitchAngle=PitchAngle;emit PitchAngleChanged();};
    void setYawAngle(qint16 YawAngle) {m_YawAngle=YawAngle;emit YawAngleChanged();};
    void setAngularRateRoll(qint16 AngularRateRoll) {m_AngularRateRoll=AngularRateRoll;emit AngularRateRollChanged();};
    void setAngularRatePitch(qint16 AngularRatePitch) {m_AngularRatePitch=AngularRatePitch;emit AngularRatePitchChanged();};
    void setAngularRateYaw(qint16 AngularRateYaw) {m_AngularRateYaw=AngularRateYaw;emit AngularRateYawChanged();};
    void setQuaternion0(double Quaternion0) {m_Quaternion0=Quaternion0;emit Quaternion0Changed();};
    void setQuaternion1(double Quaternion1) {m_Quaternion1=Quaternion1;emit Quaternion1Changed();};
    void setQuaternion2(double Quaternion2) {m_Quaternion2=Quaternion2;emit Quaternion2Changed();};
    void setQuaternion3(double Quaternion3) {m_Quaternion3=Quaternion3;emit Quaternion3Changed();};
    void setNumberOfGPSSatellite(quint8 NumberOfGPSSatellite) {m_NumberOfGPSSatellite=NumberOfGPSSatellite;emit NumberOfGPSSatelliteChanged();};
    void setAnemCommErrorCounter(quint8 AnemCommErrorCounter) {m_AnemCommErrorCounter=AnemCommErrorCounter;emit AnemCommErrorCounterChanged();};
    void setRDAltCommErrorCounter(quint8 RDAltCommErrorCounter) {m_RDAltCommErrorCounter=RDAltCommErrorCounter;emit RDAltCommErrorCounterChanged();};
    void setGNSSCommErrorCounter(quint8 GNSSCommErrorCounter) {m_GNSSCommErrorCounter=GNSSCommErrorCounter;emit GNSSCommErrorCounterChanged();};
    void setPLAltCommErrorCounter(quint8 PLAltCommErrorCounter) {m_PLAltCommErrorCounter=PLAltCommErrorCounter;emit PLAltCommErrorCounterChanged();};
    void settelemetry0(bool telemetry0) {m_telemetry0=telemetry0;emit telemetry0Changed();};
    void settelemetry1(bool telemetry1) {m_telemetry1=telemetry1;emit telemetry1Changed();};
    void settelemetry2(bool telemetry2) {m_telemetry2=telemetry2;emit telemetry2Changed();};
    void settelemetry3(bool telemetry3) {m_telemetry3=telemetry3;emit telemetry3Changed();};
    void settelemetry4(bool telemetry4) {m_telemetry4=telemetry4;emit telemetry4Changed();};
    void settelemetry5(bool telemetry5) {m_telemetry5=telemetry5;emit telemetry5Changed();};
    void settelemetry6(bool telemetry6) {m_telemetry6=telemetry6;emit telemetry6Changed();};
    void settelemetry7(bool telemetry7) {m_telemetry7=telemetry7;emit telemetry7Changed();};
    void settelemetry8(bool telemetry8) {m_telemetry8=telemetry8;emit telemetry8Changed();};
    void settelemetry9(bool telemetry9) {m_telemetry9=telemetry9;emit telemetry9Changed();};
    void settelemetry10(bool telemetry10) {m_telemetry10=telemetry10;emit telemetry10Changed();};
    void settelemetry11(bool telemetry11) {m_telemetry11=telemetry11;emit telemetry11Changed();};
    void settelemetry12(bool telemetry12) {m_telemetry12=telemetry12;emit telemetry12Changed();};
    void settelemetry13(bool telemetry13) {m_telemetry13=telemetry13;emit telemetry13Changed();};
    void settelemetry14(bool telemetry14) {m_telemetry14=telemetry14;emit telemetry14Changed();};
    void settelemetry15(bool telemetry15) {m_telemetry15=telemetry15;emit telemetry15Changed();};
    void settelemetry16(bool telemetry16) {m_telemetry16=telemetry16;emit telemetry16Changed();};
    void settelemetry17(bool telemetry17) {m_telemetry17=telemetry17;emit telemetry17Changed();};
    void settelemetry18(bool telemetry18) {m_telemetry18=telemetry18;emit telemetry18Changed();};
    void settelemetry19(bool telemetry19) {m_telemetry19=telemetry19;emit telemetry19Changed();};
    void settelemetry20(bool telemetry20) {m_telemetry20=telemetry20;emit telemetry20Changed();};
    void settelemetry21(bool telemetry21) {m_telemetry21=telemetry21;emit telemetry21Changed();};
    void settelemetry22(bool telemetry22) {m_telemetry22=telemetry22;emit telemetry22Changed();};
    void settelemetry23(bool telemetry23) {m_telemetry23=telemetry23;emit telemetry23Changed();};
    void settelemetry24(bool telemetry24) {m_telemetry24=telemetry24;emit telemetry24Changed();};
    void settelemetry25(bool telemetry25) {m_telemetry25=telemetry25;emit telemetry25Changed();};
    void settelemetry26(bool telemetry26) {m_telemetry26=telemetry26;emit telemetry26Changed();};
    void settelemetry27(bool telemetry27) {m_telemetry27=telemetry27;emit telemetry27Changed();};
    void settelemetry28(bool telemetry28) {m_telemetry28=telemetry28;emit telemetry28Changed();};
    void settelemetry29(bool telemetry29) {m_telemetry29=telemetry29;emit telemetry29Changed();};
    void settelemetry30(bool telemetry30) {m_telemetry30=telemetry30;emit telemetry30Changed();};
    void settelemetry31(bool telemetry31) {m_telemetry31=telemetry31;emit telemetry31Changed();};

    void settelemetryMsgCounter(int telemetryMsgCounter) {m_telemetryMsgCounter=telemetryMsgCounter;emit telemetryMsgCounterChanged();};

    /* MOTOR */

    void setMotorARealPosition(qint32 MotorARealPosition) {m_MotorARealPosition=MotorARealPosition;emit MotorARealPositionChanged();};
    void setMotorADemandPosition(qint32 MotorADemandPosition) {m_MotorADemandPosition=MotorADemandPosition;emit MotorADemandPositionChanged();};
    void setMotorATorque(qint32 MotorATorque) {m_MotorATorque=MotorATorque;emit MotorATorqueChanged();};
    void setMotorATemp(qint16 MotorATemp) {m_MotorATemp=MotorATemp;emit MotorATempChanged();};

    void setMotorBRealPosition(qint32 MotorBRealPosition) {m_MotorBRealPosition=MotorBRealPosition;emit MotorBRealPositionChanged();};
    void setMotorBDemandPosition(qint32 MotorBDemandPosition) {m_MotorBDemandPosition=MotorBDemandPosition;emit MotorBDemandPositionChanged();};
    void setMotorBTorque(qint32 MotorBTorque) {m_MotorBTorque=MotorBTorque;emit MotorBTorqueChanged();};
    void setMotorBTemp(qint16 MotorBTemp) {m_MotorBTemp=MotorBTemp;emit MotorBTempChanged();};

    void setBMSVoltage(quint16 BMSVoltage) {m_BMSVoltage=BMSVoltage;emit BMSVoltageChanged();};
    void setBMSAbsorption(qint16 BMSAbsorption) {m_BMSAbsorption=BMSAbsorption;emit BMSAbsorptionChanged();};
    void setBMSTemp(qint16 BMSTemp) {m_BMSTemp=BMSTemp;emit BMSTempChanged();};

    void setMotorAFaultsMask(quint32 MotorAFaultsMask) {m_MotorAFaultsMask=MotorAFaultsMask;emit MotorAFaultsMaskChanged();};
    void setMotorBFaultsMask(quint32 MotorBFaultsMask) {m_MotorBFaultsMask=MotorBFaultsMask;emit MotorBFaultsMaskChanged();};
    void setBMSFaultsMask(quint32 BMSFaultsMask) {m_BMSFaultsMask=BMSFaultsMask;emit BMSFaultsMaskChanged();};

    void setChargeValue(quint8 ChargeValue) {m_ChargeValue=ChargeValue;emit ChargeValueChanged();};

    void setmotor0(bool motor0) {m_motor0=motor0;emit motor0Changed();};
    void setmotor1(bool motor1) {m_motor1=motor1;emit motor1Changed();};
    void setmotor2(bool motor2) {m_motor2=motor2;emit motor2Changed();};
    void setmotor3(bool motor3) {m_motor3=motor3;emit motor3Changed();};
    void setmotor4(bool motor4) {m_motor4=motor4;emit motor4Changed();};
    void setmotor5(bool motor5) {m_motor5=motor5;emit motor5Changed();};
    void setmotor6(bool motor6) {m_motor6=motor6;emit motor6Changed();};
    void setmotor7(bool motor7) {m_motor7=motor7;emit motor7Changed();};
    void setmotor8(bool motor8) {m_motor8=motor8;emit motor8Changed();};
    void setmotor10(bool motor10) {m_motor10=motor10;emit motor10Changed();};
    void setmotor11(bool motor11) {m_motor11=motor11;emit motor11Changed();};
    void setmotor12(bool motor12) {m_motor12=motor12;emit motor12Changed();};
    void setmotor13(bool motor13) {m_motor13=motor13;emit motor13Changed();};
    void setmotor14(bool motor14) {m_motor14=motor14;emit motor14Changed();};
    void setmotor15(bool motor15) {m_motor15=motor15;emit motor15Changed();};
    void setmotor16(bool motor16) {m_motor16=motor16;emit motor16Changed();};
    void setmotor17(bool motor17) {m_motor17=motor17;emit motor17Changed();};
    void setmotor18(bool motor18) {m_motor18=motor18;emit motor18Changed();};
    void setmotor19(bool motor19) {m_motor19=motor19;emit motor19Changed();};
    void setmotor20(bool motor20) {m_motor20=motor20;emit motor20Changed();};
    void setmotor21(bool motor21) {m_motor21=motor21;emit motor21Changed();};
    void setmotor22(bool motor22) {m_motor22=motor22;emit motor22Changed();};
    void setmotor23(bool motor23) {m_motor23=motor23;emit motor23Changed();};
    void setmotor24(bool motor24) {m_motor24=motor24;emit motor24Changed();};

    void setmotorAMask0(bool motorAMask0) {m_motorAMask0=motorAMask0;emit motorAMask0Changed();};
    void setmotorAMask1(bool motorAMask1) {m_motorAMask1=motorAMask1;emit motorAMask1Changed();};
    void setmotorAMask2(bool motorAMask2) {m_motorAMask2=motorAMask2;emit motorAMask2Changed();};
    void setmotorAMask3(bool motorAMask3) {m_motorAMask3=motorAMask3;emit motorAMask3Changed();};
    void setmotorAMask4(bool motorAMask4) {m_motorAMask4=motorAMask4;emit motorAMask4Changed();};
    void setmotorAMask5(bool motorAMask5) {m_motorAMask5=motorAMask5;emit motorAMask5Changed();};
    void setmotorAMask6(bool motorAMask6) {m_motorAMask6=motorAMask6;emit motorAMask6Changed();};
    void setmotorAMask7(bool motorAMask7) {m_motorAMask7=motorAMask7;emit motorAMask7Changed();};
    void setmotorAMask8(bool motorAMask8) {m_motorAMask8=motorAMask8;emit motorAMask8Changed();};
    void setmotorAMask9(bool motorAMask9) {m_motorAMask9=motorAMask9;emit motorAMask9Changed();};
    void setmotorAMask10(bool motorAMask10) {m_motorAMask10=motorAMask10;emit motorAMask10Changed();};
    void setmotorAMask11(bool motorAMask11) {m_motorAMask11=motorAMask11;emit motorAMask11Changed();};
    void setmotorAMask12(bool motorAMask12) {m_motorAMask12=motorAMask12;emit motorAMask12Changed();};
    void setmotorAMask13(bool motorAMask13) {m_motorAMask13=motorAMask13;emit motorAMask13Changed();};
    void setmotorAMask14(bool motorAMask14) {m_motorAMask14=motorAMask14;emit motorAMask14Changed();};
    void setmotorAMask15(bool motorAMask15) {m_motorAMask15=motorAMask15;emit motorAMask15Changed();};
    void setmotorAMask16(bool motorAMask16) {m_motorAMask16=motorAMask16;emit motorAMask16Changed();};
    void setmotorAMask17(bool motorAMask17) {m_motorAMask17=motorAMask17;emit motorAMask17Changed();};
    void setmotorAMask18(bool motorAMask18) {m_motorAMask18=motorAMask18;emit motorAMask18Changed();};
    void setmotorAMask19(bool motorAMask19) {m_motorAMask19=motorAMask19;emit motorAMask19Changed();};
    void setmotorAMask20(bool motorAMask20) {m_motorAMask20=motorAMask20;emit motorAMask20Changed();};
    void setmotorAMask21(bool motorAMask21) {m_motorAMask21=motorAMask21;emit motorAMask21Changed();};
    void setmotorAMask22(bool motorAMask22) {m_motorAMask22=motorAMask22;emit motorAMask22Changed();};
    void setmotorAMask23(bool motorAMask23) {m_motorAMask23=motorAMask23;emit motorAMask23Changed();};
    void setmotorAMask24(bool motorAMask24) {m_motorAMask24=motorAMask24;emit motorAMask24Changed();};
    void setmotorAMask25(bool motorAMask25) {m_motorAMask25=motorAMask25;emit motorAMask25Changed();};
    void setmotorAMask26(bool motorAMask26) {m_motorAMask26=motorAMask26;emit motorAMask26Changed();};
    void setmotorAMask27(bool motorAMask27) {m_motorAMask27=motorAMask27;emit motorAMask27Changed();};
    void setmotorAMask28(bool motorAMask28) {m_motorAMask28=motorAMask28;emit motorAMask28Changed();};
    void setmotorAMask29(bool motorAMask29) {m_motorAMask29=motorAMask29;emit motorAMask29Changed();};
    void setmotorAMask30(bool motorAMask30) {m_motorAMask30=motorAMask30;emit motorAMask30Changed();};
    void setmotorAMask31(bool motorAMask31) {m_motorAMask31=motorAMask31;emit motorAMask31Changed();};

    void setmotorBMask0(bool motorBMask0) {m_motorBMask0=motorBMask0;emit motorBMask0Changed();};
    void setmotorBMask1(bool motorBMask1) {m_motorBMask1=motorBMask1;emit motorBMask1Changed();};
    void setmotorBMask2(bool motorBMask2) {m_motorBMask2=motorBMask2;emit motorBMask2Changed();};
    void setmotorBMask3(bool motorBMask3) {m_motorBMask3=motorBMask3;emit motorBMask3Changed();};
    void setmotorBMask4(bool motorBMask4) {m_motorBMask4=motorBMask4;emit motorBMask4Changed();};
    void setmotorBMask5(bool motorBMask5) {m_motorBMask5=motorBMask5;emit motorBMask5Changed();};
    void setmotorBMask6(bool motorBMask6) {m_motorBMask6=motorBMask6;emit motorBMask6Changed();};
    void setmotorBMask7(bool motorBMask7) {m_motorBMask7=motorBMask7;emit motorBMask7Changed();};
    void setmotorBMask8(bool motorBMask8) {m_motorBMask8=motorBMask8;emit motorBMask8Changed();};
    void setmotorBMask9(bool motorBMask9) {m_motorBMask9=motorBMask9;emit motorBMask9Changed();};
    void setmotorBMask10(bool motorBMask10) {m_motorBMask10=motorBMask10;emit motorBMask10Changed();};
    void setmotorBMask11(bool motorBMask11) {m_motorBMask11=motorBMask11;emit motorBMask11Changed();};
    void setmotorBMask12(bool motorBMask12) {m_motorBMask12=motorBMask12;emit motorBMask12Changed();};
    void setmotorBMask13(bool motorBMask13) {m_motorBMask13=motorBMask13;emit motorBMask13Changed();};
    void setmotorBMask14(bool motorBMask14) {m_motorBMask14=motorBMask14;emit motorBMask14Changed();};
    void setmotorBMask15(bool motorBMask15) {m_motorBMask15=motorBMask15;emit motorBMask15Changed();};
    void setmotorBMask16(bool motorBMask16) {m_motorBMask16=motorBMask16;emit motorBMask16Changed();};
    void setmotorBMask17(bool motorBMask17) {m_motorBMask17=motorBMask17;emit motorBMask17Changed();};
    void setmotorBMask18(bool motorBMask18) {m_motorBMask18=motorBMask18;emit motorBMask18Changed();};
    void setmotorBMask19(bool motorBMask19) {m_motorBMask19=motorBMask19;emit motorBMask19Changed();};
    void setmotorBMask20(bool motorBMask20) {m_motorBMask20=motorBMask20;emit motorBMask20Changed();};
    void setmotorBMask21(bool motorBMask21) {m_motorBMask21=motorBMask21;emit motorBMask21Changed();};
    void setmotorBMask22(bool motorBMask22) {m_motorBMask22=motorBMask22;emit motorBMask22Changed();};
    void setmotorBMask23(bool motorBMask23) {m_motorBMask23=motorBMask23;emit motorBMask23Changed();};
    void setmotorBMask24(bool motorBMask24) {m_motorBMask24=motorBMask24;emit motorBMask24Changed();};
    void setmotorBMask25(bool motorBMask25) {m_motorBMask25=motorBMask25;emit motorBMask25Changed();};
    void setmotorBMask26(bool motorBMask26) {m_motorBMask26=motorBMask26;emit motorBMask26Changed();};
    void setmotorBMask27(bool motorBMask27) {m_motorBMask27=motorBMask27;emit motorBMask27Changed();};
    void setmotorBMask28(bool motorBMask28) {m_motorBMask28=motorBMask28;emit motorBMask28Changed();};
    void setmotorBMask29(bool motorBMask29) {m_motorBMask29=motorBMask29;emit motorBMask29Changed();};
    void setmotorBMask30(bool motorBMask30) {m_motorBMask30=motorBMask30;emit motorBMask30Changed();};
    void setmotorBMask31(bool motorBMask31) {m_motorBMask31=motorBMask31;emit motorBMask31Changed();};

    void setBMS0(bool BMS0) {m_BMS0=BMS0;emit BMS0Changed();};
    void setBMS1(bool BMS1) {m_BMS1=BMS1;emit BMS1Changed();};
    void setBMS2(bool BMS2) {m_BMS2=BMS2;emit BMS2Changed();};
    void setBMS3(bool BMS3) {m_BMS3=BMS3;emit BMS3Changed();};
    void setBMS4(bool BMS4) {m_BMS4=BMS4;emit BMS4Changed();};
    void setBMS5(bool BMS5) {m_BMS5=BMS5;emit BMS5Changed();};
    void setBMS6(bool BMS6) {m_BMS6=BMS6;emit BMS6Changed();};
    void setBMS7(bool BMS7) {m_BMS7=BMS7;emit BMS7Changed();};
    void setBMS8(bool BMS8) {m_BMS8=BMS8;emit BMS8Changed();};
    void setBMS9(bool BMS9) {m_BMS9=BMS9;emit BMS9Changed();};
    void setBMS10(bool BMS10) {m_BMS10=BMS10;emit BMS10Changed();};
    void setBMS11(bool BMS11) {m_BMS11=BMS11;emit BMS11Changed();};
    void setBMS12(bool BMS12) {m_BMS12=BMS12;emit BMS12Changed();};
    void setBMS13(bool BMS13) {m_BMS13=BMS13;emit BMS13Changed();};
    void setBMS14(bool BMS14) {m_BMS14=BMS14;emit BMS14Changed();};
    void setBMS15(bool BMS15) {m_BMS15=BMS15;emit BMS15Changed();};
    void setBMS16(bool BMS16) {m_BMS16=BMS16;emit BMS16Changed();};
    void setBMS17(bool BMS17) {m_BMS17=BMS17;emit BMS17Changed();};
    void setBMS18(bool BMS18) {m_BMS18=BMS18;emit BMS18Changed();};
    void setBMS19(bool BMS19) {m_BMS19=BMS19;emit BMS19Changed();};
    void setBMS20(bool BMS20) {m_BMS20=BMS20;emit BMS20Changed();};
    void setBMS21(bool BMS21) {m_BMS21=BMS21;emit BMS21Changed();};
    void setBMS22(bool BMS22) {m_BMS22=BMS22;emit BMS22Changed();};
    void setBMS23(bool BMS23) {m_BMS23=BMS23;emit BMS23Changed();};
    void setBMS24(bool BMS24) {m_BMS24=BMS24;emit BMS24Changed();};
    void setBMS25(bool BMS25) {m_BMS25=BMS25;emit BMS25Changed();};
    void setBMS26(bool BMS26) {m_BMS26=BMS26;emit BMS26Changed();};
    void setBMS27(bool BMS27) {m_BMS27=BMS27;emit BMS27Changed();};
    void setBMS28(bool BMS28) {m_BMS28=BMS28;emit BMS28Changed();};
    void setBMS29(bool BMS29) {m_BMS29=BMS29;emit BMS29Changed();};
    void setBMS30(bool BMS30) {m_BMS30=BMS30;emit BMS30Changed();};
    void setBMS31(bool BMS31) {m_BMS31=BMS31;emit BMS31Changed();};

    void setmotorMsgCounter(int motorMsgCounter) {m_motorMsgCounter=motorMsgCounter;emit motorMsgCounterChanged();};

    /* SYSTEM */

    void setFlightMode(quint8 FlightMode) {m_FlightMode=FlightMode;emit FlightModeChanged();};
    void setFlightPhase(quint8 FlightPhase) {m_FlightPhase=FlightPhase;emit FlightPhaseChanged();};
    void setFlightPhaseExecutionTime(quint32 FlightPhaseExecutionTime) {m_FlightPhaseExecutionTime=FlightPhaseExecutionTime;emit FlightPhaseExecutionTimeChanged();};
    void setCoreModuleStatusMask(quint32 CoreModuleStatusMask) {m_CoreModuleStatusMask=CoreModuleStatusMask;emit CoreModuleStatusMaskChanged();};
    void setTelemetryModuleStatusMask(quint64 TelemetryModuleStatusMask) {m_TelemetryModuleStatusMask=TelemetryModuleStatusMask;emit TelemetryModuleStatusMaskChanged();};
    void setGuidanceModuleStatusMask(quint32 GuidanceModuleStatusMask) {m_GuidanceModuleStatusMask=GuidanceModuleStatusMask;emit GuidanceModuleStatusMaskChanged();};
    void setStorageModuleStatusMask(quint32 StorageModuleStatusMask) {m_StorageModuleStatusMask=StorageModuleStatusMask;emit StorageModuleStatusMaskChanged();};
    void setRadioLinkModuleStatusMask(quint32 RadioLinkModuleStatusMask) {m_RadioLinkModuleStatusMask=RadioLinkModuleStatusMask;emit RadioLinkModuleStatusMaskChanged();};
    void setMotorControlStatusMask(quint32 MotorControlStatusMask) {m_MotorControlStatusMask=MotorControlStatusMask;emit MotorControlStatusMaskChanged();};

    void setcommunicationErrorCounter(quint8 communicationErrorCounter) {m_communicationErrorCounter=communicationErrorCounter;emit communicationErrorCounterChanged();};
    void setsystemCoreMask0(bool systemCoreMask0) {m_systemCoreMask0=systemCoreMask0;emit systemCoreMask0Changed();};
    void setsystemCoreMask1(bool systemCoreMask1) {m_systemCoreMask1=systemCoreMask1;emit systemCoreMask1Changed();};
    void setsystemCoreMask2(bool systemCoreMask2) {m_systemCoreMask2=systemCoreMask2;emit systemCoreMask2Changed();};
    void setsystemCoreMask3(bool systemCoreMask3) {m_systemCoreMask3=systemCoreMask3;emit systemCoreMask3Changed();};
    void setsystemCoreMask4(bool systemCoreMask4) {m_systemCoreMask4=systemCoreMask4;emit systemCoreMask4Changed();};
    void setsystemCoreMask5(bool systemCoreMask5) {m_systemCoreMask5=systemCoreMask5;emit systemCoreMask5Changed();};
    void setsystemCoreMask6(bool systemCoreMask6) {m_systemCoreMask6=systemCoreMask6;emit systemCoreMask6Changed();};
    void setsystemCoreMask7(bool systemCoreMask7) {m_systemCoreMask7=systemCoreMask7;emit systemCoreMask7Changed();};
    void setsystemCoreMask8(bool systemCoreMask8) {m_systemCoreMask8=systemCoreMask8;emit systemCoreMask8Changed();};
    void setsystemCoreMask9(bool systemCoreMask9) {m_systemCoreMask9=systemCoreMask9;emit systemCoreMask9Changed();};
    void setsystemCoreMask10(bool systemCoreMask10) {m_systemCoreMask10=systemCoreMask10;emit systemCoreMask10Changed();};
    void setsystemCoreMask11(bool systemCoreMask11) {m_systemCoreMask11=systemCoreMask11;emit systemCoreMask11Changed();};
    void setsystemCoreMask12(bool systemCoreMask12) {m_systemCoreMask12=systemCoreMask12;emit systemCoreMask12Changed();};
    void setsystemCoreMask13(bool systemCoreMask13) {m_systemCoreMask13=systemCoreMask13;emit systemCoreMask13Changed();};
    void setsystemCoreMask14(bool systemCoreMask14) {m_systemCoreMask14=systemCoreMask14;emit systemCoreMask14Changed();};
    void setsystemCoreMask15(bool systemCoreMask15) {m_systemCoreMask15=systemCoreMask15;emit systemCoreMask15Changed();};
    void setsystemCoreMask16(bool systemCoreMask16) {m_systemCoreMask16=systemCoreMask16;emit systemCoreMask16Changed();};
    void setsystemCoreMask17(bool systemCoreMask17) {m_systemCoreMask17=systemCoreMask17;emit systemCoreMask17Changed();};
    void setsystemCoreMask18(bool systemCoreMask18) {m_systemCoreMask18=systemCoreMask18;emit systemCoreMask18Changed();};
    void setsystemCoreMask19(bool systemCoreMask19) {m_systemCoreMask19=systemCoreMask19;emit systemCoreMask19Changed();};
    void setsystemCoreMask20(bool systemCoreMask20) {m_systemCoreMask20=systemCoreMask20;emit systemCoreMask20Changed();};
    void setsystemCoreMask21(bool systemCoreMask21) {m_systemCoreMask21=systemCoreMask21;emit systemCoreMask21Changed();};
    void setsystemCoreMask22(bool systemCoreMask22) {m_systemCoreMask22=systemCoreMask22;emit systemCoreMask22Changed();};
    void setsystemCoreMask23(bool systemCoreMask23) {m_systemCoreMask23=systemCoreMask23;emit systemCoreMask23Changed();};
    void setsystemCoreMask24(bool systemCoreMask24) {m_systemCoreMask24=systemCoreMask24;emit systemCoreMask24Changed();};
    void setsystemCoreMask25(bool systemCoreMask25) {m_systemCoreMask25=systemCoreMask25;emit systemCoreMask25Changed();};
    void setsystemCoreMask26(bool systemCoreMask26) {m_systemCoreMask26=systemCoreMask26;emit systemCoreMask26Changed();};
    void setsystemCoreMask27(bool systemCoreMask27) {m_systemCoreMask27=systemCoreMask27;emit systemCoreMask27Changed();};
    void setsystemCoreMask28(bool systemCoreMask28) {m_systemCoreMask28=systemCoreMask28;emit systemCoreMask28Changed();};
    void setsystemCoreMask29(bool systemCoreMask29) {m_systemCoreMask29=systemCoreMask29;emit systemCoreMask29Changed();};
    void setsystemCoreMask30(bool systemCoreMask30) {m_systemCoreMask30=systemCoreMask30;emit systemCoreMask30Changed();};
    void setsystemCoreMask31(bool systemCoreMask31) {m_systemCoreMask31=systemCoreMask31;emit systemCoreMask31Changed();};

    void setsystemStorageMask0(bool systemStorageMask0) {m_systemStorageMask0=systemStorageMask0;emit systemStorageMask0Changed();};
    void setsystemStorageMask1(bool systemStorageMask1) {m_systemStorageMask1=systemStorageMask1;emit systemStorageMask1Changed();};
    void setsystemStorageMask2(bool systemStorageMask2) {m_systemStorageMask2=systemStorageMask2;emit systemStorageMask2Changed();};
    void setsystemStorageMask3(bool systemStorageMask3) {m_systemStorageMask3=systemStorageMask3;emit systemStorageMask3Changed();};
    void setsystemStorageMask4(bool systemStorageMask4) {m_systemStorageMask4=systemStorageMask4;emit systemStorageMask4Changed();};
    void setsystemStorageMask5(bool systemStorageMask5) {m_systemStorageMask5=systemStorageMask5;emit systemStorageMask5Changed();};
    void setsystemStorageMask6(bool systemStorageMask6) {m_systemStorageMask6=systemStorageMask6;emit systemStorageMask6Changed();};
    void setsystemStorageMask7(bool systemStorageMask7) {m_systemStorageMask7=systemStorageMask7;emit systemStorageMask7Changed();};
    void setsystemStorageMask8(bool systemStorageMask8) {m_systemStorageMask8=systemStorageMask8;emit systemStorageMask8Changed();};
    void setsystemStorageMask9(bool systemStorageMask9) {m_systemStorageMask9=systemStorageMask9;emit systemStorageMask9Changed();};
    void setsystemStorageMask10(bool systemStorageMask10) {m_systemStorageMask10=systemStorageMask10;emit systemStorageMask10Changed();};
    void setsystemStorageMask11(bool systemStorageMask11) {m_systemStorageMask11=systemStorageMask11;emit systemStorageMask11Changed();};
    void setsystemStorageMask12(bool systemStorageMask12) {m_systemStorageMask12=systemStorageMask12;emit systemStorageMask12Changed();};
    void setsystemStorageMask13(bool systemStorageMask13) {m_systemStorageMask13=systemStorageMask13;emit systemStorageMask13Changed();};
    void setsystemStorageMask14(bool systemStorageMask14) {m_systemStorageMask14=systemStorageMask14;emit systemStorageMask14Changed();};
    void setsystemStorageMask15(bool systemStorageMask15) {m_systemStorageMask15=systemStorageMask15;emit systemStorageMask15Changed();};
    void setsystemStorageMask16(bool systemStorageMask16) {m_systemStorageMask16=systemStorageMask16;emit systemStorageMask16Changed();};
    void setsystemStorageMask17(bool systemStorageMask17) {m_systemStorageMask17=systemStorageMask17;emit systemStorageMask17Changed();};
    void setsystemStorageMask18(bool systemStorageMask18) {m_systemStorageMask18=systemStorageMask18;emit systemStorageMask18Changed();};
    void setsystemStorageMask19(bool systemStorageMask19) {m_systemStorageMask19=systemStorageMask19;emit systemStorageMask19Changed();};
    void setsystemStorageMask20(bool systemStorageMask20) {m_systemStorageMask20=systemStorageMask20;emit systemStorageMask20Changed();};
    void setsystemStorageMask21(bool systemStorageMask21) {m_systemStorageMask21=systemStorageMask21;emit systemStorageMask21Changed();};
    void setsystemStorageMask22(bool systemStorageMask22) {m_systemStorageMask22=systemStorageMask22;emit systemStorageMask22Changed();};
    void setsystemStorageMask23(bool systemStorageMask23) {m_systemStorageMask23=systemStorageMask23;emit systemStorageMask23Changed();};
    void setsystemStorageMask24(bool systemStorageMask24) {m_systemStorageMask24=systemStorageMask24;emit systemStorageMask24Changed();};
    void setsystemStorageMask25(bool systemStorageMask25) {m_systemStorageMask25=systemStorageMask25;emit systemStorageMask25Changed();};
    void setsystemStorageMask26(bool systemStorageMask26) {m_systemStorageMask26=systemStorageMask26;emit systemStorageMask26Changed();};
    void setsystemStorageMask27(bool systemStorageMask27) {m_systemStorageMask27=systemStorageMask27;emit systemStorageMask27Changed();};
    void setsystemStorageMask28(bool systemStorageMask28) {m_systemStorageMask28=systemStorageMask28;emit systemStorageMask28Changed();};
    void setsystemStorageMask29(bool systemStorageMask29) {m_systemStorageMask29=systemStorageMask29;emit systemStorageMask29Changed();};
    void setsystemStorageMask30(bool systemStorageMask30) {m_systemStorageMask30=systemStorageMask30;emit systemStorageMask30Changed();};
    void setsystemStorageMask31(bool systemStorageMask31) {m_systemStorageMask31=systemStorageMask31;emit systemStorageMask31Changed();};

    void setsystemGuidanceMask0(bool systemGuidanceMask0) {m_systemGuidanceMask0=systemGuidanceMask0;emit systemGuidanceMask0Changed();};
    void setsystemGuidanceMask1(bool systemGuidanceMask1) {m_systemGuidanceMask1=systemGuidanceMask1;emit systemGuidanceMask1Changed();};
    void setsystemGuidanceMask2(bool systemGuidanceMask2) {m_systemGuidanceMask2=systemGuidanceMask2;emit systemGuidanceMask2Changed();};
    void setsystemGuidanceMask3(bool systemGuidanceMask3) {m_systemGuidanceMask3=systemGuidanceMask3;emit systemGuidanceMask3Changed();};
    void setsystemGuidanceMask4(bool systemGuidanceMask4) {m_systemGuidanceMask4=systemGuidanceMask4;emit systemGuidanceMask4Changed();};
    void setsystemGuidanceMask5(bool systemGuidanceMask5) {m_systemGuidanceMask5=systemGuidanceMask5;emit systemGuidanceMask5Changed();};
    void setsystemGuidanceMask6(bool systemGuidanceMask6) {m_systemGuidanceMask6=systemGuidanceMask6;emit systemGuidanceMask6Changed();};
    void setsystemGuidanceMask7(bool systemGuidanceMask7) {m_systemGuidanceMask7=systemGuidanceMask7;emit systemGuidanceMask7Changed();};
    void setsystemGuidanceMask8(bool systemGuidanceMask8) {m_systemGuidanceMask8=systemGuidanceMask8;emit systemGuidanceMask8Changed();};
    void setsystemGuidanceMask9(bool systemGuidanceMask9) {m_systemGuidanceMask9=systemGuidanceMask9;emit systemGuidanceMask9Changed();};
    void setsystemGuidanceMask10(bool systemGuidanceMask10) {m_systemGuidanceMask10=systemGuidanceMask10;emit systemGuidanceMask10Changed();};
    void setsystemGuidanceMask11(bool systemGuidanceMask11) {m_systemGuidanceMask11=systemGuidanceMask11;emit systemGuidanceMask11Changed();};
    void setsystemGuidanceMask12(bool systemGuidanceMask12) {m_systemGuidanceMask12=systemGuidanceMask12;emit systemGuidanceMask12Changed();};
    void setsystemGuidanceMask13(bool systemGuidanceMask13) {m_systemGuidanceMask13=systemGuidanceMask13;emit systemGuidanceMask13Changed();};
    void setsystemGuidanceMask14(bool systemGuidanceMask14) {m_systemGuidanceMask14=systemGuidanceMask14;emit systemGuidanceMask14Changed();};
    void setsystemGuidanceMask15(bool systemGuidanceMask15) {m_systemGuidanceMask15=systemGuidanceMask15;emit systemGuidanceMask15Changed();};
    void setsystemGuidanceMask16(bool systemGuidanceMask16) {m_systemGuidanceMask16=systemGuidanceMask16;emit systemGuidanceMask16Changed();};
    void setsystemGuidanceMask17(bool systemGuidanceMask17) {m_systemGuidanceMask17=systemGuidanceMask17;emit systemGuidanceMask17Changed();};
    void setsystemGuidanceMask18(bool systemGuidanceMask18) {m_systemGuidanceMask18=systemGuidanceMask18;emit systemGuidanceMask18Changed();};
    void setsystemGuidanceMask19(bool systemGuidanceMask19) {m_systemGuidanceMask19=systemGuidanceMask19;emit systemGuidanceMask19Changed();};
    void setsystemGuidanceMask20(bool systemGuidanceMask20) {m_systemGuidanceMask20=systemGuidanceMask20;emit systemGuidanceMask20Changed();};
    void setsystemGuidanceMask21(bool systemGuidanceMask21) {m_systemGuidanceMask21=systemGuidanceMask21;emit systemGuidanceMask21Changed();};
    void setsystemGuidanceMask22(bool systemGuidanceMask22) {m_systemGuidanceMask22=systemGuidanceMask22;emit systemGuidanceMask22Changed();};
    void setsystemGuidanceMask23(bool systemGuidanceMask23) {m_systemGuidanceMask23=systemGuidanceMask23;emit systemGuidanceMask23Changed();};
    void setsystemGuidanceMask24(bool systemGuidanceMask24) {m_systemGuidanceMask24=systemGuidanceMask24;emit systemGuidanceMask24Changed();};
    void setsystemGuidanceMask25(bool systemGuidanceMask25) {m_systemGuidanceMask25=systemGuidanceMask25;emit systemGuidanceMask25Changed();};
    void setsystemGuidanceMask26(bool systemGuidanceMask26) {m_systemGuidanceMask26=systemGuidanceMask26;emit systemGuidanceMask26Changed();};
    void setsystemGuidanceMask27(bool systemGuidanceMask27) {m_systemGuidanceMask27=systemGuidanceMask27;emit systemGuidanceMask27Changed();};
    void setsystemGuidanceMask28(bool systemGuidanceMask28) {m_systemGuidanceMask28=systemGuidanceMask28;emit systemGuidanceMask28Changed();};
    void setsystemGuidanceMask29(bool systemGuidanceMask29) {m_systemGuidanceMask29=systemGuidanceMask29;emit systemGuidanceMask29Changed();};
    void setsystemGuidanceMask30(bool systemGuidanceMask30) {m_systemGuidanceMask30=systemGuidanceMask30;emit systemGuidanceMask30Changed();};
    void setsystemGuidanceMask31(bool systemGuidanceMask31) {m_systemGuidanceMask31=systemGuidanceMask31;emit systemGuidanceMask31Changed();};

    void setsystemMotorControlMask0(bool systemMotorControlMask0) {m_systemMotorControlMask0=systemMotorControlMask0;emit systemMotorControlMask0Changed();};
    void setsystemMotorControlMask1(bool systemMotorControlMask1) {m_systemMotorControlMask1=systemMotorControlMask1;emit systemMotorControlMask1Changed();};
    void setsystemMotorControlMask2(bool systemMotorControlMask2) {m_systemMotorControlMask2=systemMotorControlMask2;emit systemMotorControlMask2Changed();};
    void setsystemMotorControlMask3(bool systemMotorControlMask3) {m_systemMotorControlMask3=systemMotorControlMask3;emit systemMotorControlMask3Changed();};
    void setsystemMotorControlMask4(bool systemMotorControlMask4) {m_systemMotorControlMask4=systemMotorControlMask4;emit systemMotorControlMask4Changed();};
    void setsystemMotorControlMask5(bool systemMotorControlMask5) {m_systemMotorControlMask5=systemMotorControlMask5;emit systemMotorControlMask5Changed();};
    void setsystemMotorControlMask6(bool systemMotorControlMask6) {m_systemMotorControlMask6=systemMotorControlMask6;emit systemMotorControlMask6Changed();};
    void setsystemMotorControlMask7(bool systemMotorControlMask7) {m_systemMotorControlMask7=systemMotorControlMask7;emit systemMotorControlMask7Changed();};
    void setsystemMotorControlMask8(bool systemMotorControlMask8) {m_systemMotorControlMask8=systemMotorControlMask8;emit systemMotorControlMask8Changed();};
    void setsystemMotorControlMask9(bool systemMotorControlMask9) {m_systemMotorControlMask9=systemMotorControlMask9;emit systemMotorControlMask9Changed();};
    void setsystemMotorControlMask10(bool systemMotorControlMask10) {m_systemMotorControlMask10=systemMotorControlMask10;emit systemMotorControlMask10Changed();};
    void setsystemMotorControlMask11(bool systemMotorControlMask11) {m_systemMotorControlMask11=systemMotorControlMask11;emit systemMotorControlMask11Changed();};
    void setsystemMotorControlMask12(bool systemMotorControlMask12) {m_systemMotorControlMask12=systemMotorControlMask12;emit systemMotorControlMask12Changed();};
    void setsystemMotorControlMask13(bool systemMotorControlMask13) {m_systemMotorControlMask13=systemMotorControlMask13;emit systemMotorControlMask13Changed();};
    void setsystemMotorControlMask14(bool systemMotorControlMask14) {m_systemMotorControlMask14=systemMotorControlMask14;emit systemMotorControlMask14Changed();};
    void setsystemMotorControlMask15(bool systemMotorControlMask15) {m_systemMotorControlMask15=systemMotorControlMask15;emit systemMotorControlMask15Changed();};
    void setsystemMotorControlMask16(bool systemMotorControlMask16) {m_systemMotorControlMask16=systemMotorControlMask16;emit systemMotorControlMask16Changed();};
    void setsystemMotorControlMask17(bool systemMotorControlMask17) {m_systemMotorControlMask17=systemMotorControlMask17;emit systemMotorControlMask17Changed();};
    void setsystemMotorControlMask18(bool systemMotorControlMask18) {m_systemMotorControlMask18=systemMotorControlMask18;emit systemMotorControlMask18Changed();};
    void setsystemMotorControlMask19(bool systemMotorControlMask19) {m_systemMotorControlMask19=systemMotorControlMask19;emit systemMotorControlMask19Changed();};
    void setsystemMotorControlMask20(bool systemMotorControlMask20) {m_systemMotorControlMask20=systemMotorControlMask20;emit systemMotorControlMask20Changed();};
    void setsystemMotorControlMask21(bool systemMotorControlMask21) {m_systemMotorControlMask21=systemMotorControlMask21;emit systemMotorControlMask21Changed();};
    void setsystemMotorControlMask22(bool systemMotorControlMask22) {m_systemMotorControlMask22=systemMotorControlMask22;emit systemMotorControlMask22Changed();};
    void setsystemMotorControlMask23(bool systemMotorControlMask23) {m_systemMotorControlMask23=systemMotorControlMask23;emit systemMotorControlMask23Changed();};
    void setsystemMotorControlMask24(bool systemMotorControlMask24) {m_systemMotorControlMask24=systemMotorControlMask24;emit systemMotorControlMask24Changed();};
    void setsystemMotorControlMask25(bool systemMotorControlMask25) {m_systemMotorControlMask25=systemMotorControlMask25;emit systemMotorControlMask25Changed();};
    void setsystemMotorControlMask26(bool systemMotorControlMask26) {m_systemMotorControlMask26=systemMotorControlMask26;emit systemMotorControlMask26Changed();};
    void setsystemMotorControlMask27(bool systemMotorControlMask27) {m_systemMotorControlMask27=systemMotorControlMask27;emit systemMotorControlMask27Changed();};
    void setsystemMotorControlMask28(bool systemMotorControlMask28) {m_systemMotorControlMask28=systemMotorControlMask28;emit systemMotorControlMask28Changed();};
    void setsystemMotorControlMask29(bool systemMotorControlMask29) {m_systemMotorControlMask29=systemMotorControlMask29;emit systemMotorControlMask29Changed();};
    void setsystemMotorControlMask30(bool systemMotorControlMask30) {m_systemMotorControlMask30=systemMotorControlMask30;emit systemMotorControlMask30Changed();};
    void setsystemMotorControlMask31(bool systemMotorControlMask31) {m_systemMotorControlMask31=systemMotorControlMask31;emit systemMotorControlMask31Changed();};


    void setsystemTelemetryMask0(bool systemTelemetryMask0) {m_systemTelemetryMask0=systemTelemetryMask0;emit systemTelemetryMask0Changed();};
    void setsystemTelemetryMask1(bool systemTelemetryMask1) {m_systemTelemetryMask1=systemTelemetryMask1;emit systemTelemetryMask1Changed();};
    void setsystemTelemetryMask2(bool systemTelemetryMask2) {m_systemTelemetryMask2=systemTelemetryMask2;emit systemTelemetryMask2Changed();};
    void setsystemTelemetryMask3(bool systemTelemetryMask3) {m_systemTelemetryMask3=systemTelemetryMask3;emit systemTelemetryMask3Changed();};
    void setsystemTelemetryMask4(bool systemTelemetryMask4) {m_systemTelemetryMask4=systemTelemetryMask4;emit systemTelemetryMask4Changed();};
    void setsystemTelemetryMask5(bool systemTelemetryMask5) {m_systemTelemetryMask5=systemTelemetryMask5;emit systemTelemetryMask5Changed();};
    void setsystemTelemetryMask6(bool systemTelemetryMask6) {m_systemTelemetryMask6=systemTelemetryMask6;emit systemTelemetryMask6Changed();};
    void setsystemTelemetryMask7(bool systemTelemetryMask7) {m_systemTelemetryMask7=systemTelemetryMask7;emit systemTelemetryMask7Changed();};
    void setsystemTelemetryMask8(bool systemTelemetryMask8) {m_systemTelemetryMask8=systemTelemetryMask8;emit systemTelemetryMask8Changed();};
    void setsystemTelemetryMask9(bool systemTelemetryMask9) {m_systemTelemetryMask9=systemTelemetryMask9;emit systemTelemetryMask9Changed();};
    void setsystemTelemetryMask10(bool systemTelemetryMask10) {m_systemTelemetryMask10=systemTelemetryMask10;emit systemTelemetryMask10Changed();};
    void setsystemTelemetryMask11(bool systemTelemetryMask11) {m_systemTelemetryMask11=systemTelemetryMask11;emit systemTelemetryMask11Changed();};
    void setsystemTelemetryMask12(bool systemTelemetryMask12) {m_systemTelemetryMask12=systemTelemetryMask12;emit systemTelemetryMask12Changed();};
    void setsystemTelemetryMask13(bool systemTelemetryMask13) {m_systemTelemetryMask13=systemTelemetryMask13;emit systemTelemetryMask13Changed();};
    void setsystemTelemetryMask14(bool systemTelemetryMask14) {m_systemTelemetryMask14=systemTelemetryMask14;emit systemTelemetryMask14Changed();};
    void setsystemTelemetryMask15(bool systemTelemetryMask15) {m_systemTelemetryMask15=systemTelemetryMask15;emit systemTelemetryMask15Changed();};
    void setsystemTelemetryMask16(bool systemTelemetryMask16) {m_systemTelemetryMask16=systemTelemetryMask16;emit systemTelemetryMask16Changed();};
    void setsystemTelemetryMask17(bool systemTelemetryMask17) {m_systemTelemetryMask17=systemTelemetryMask17;emit systemTelemetryMask17Changed();};
    void setsystemTelemetryMask18(bool systemTelemetryMask18) {m_systemTelemetryMask18=systemTelemetryMask18;emit systemTelemetryMask18Changed();};
    void setsystemTelemetryMask19(bool systemTelemetryMask19) {m_systemTelemetryMask19=systemTelemetryMask19;emit systemTelemetryMask19Changed();};
    void setsystemTelemetryMask20(bool systemTelemetryMask20) {m_systemTelemetryMask20=systemTelemetryMask20;emit systemTelemetryMask20Changed();};
    void setsystemTelemetryMask21(bool systemTelemetryMask21) {m_systemTelemetryMask21=systemTelemetryMask21;emit systemTelemetryMask21Changed();};
    void setsystemTelemetryMask22(bool systemTelemetryMask22) {m_systemTelemetryMask22=systemTelemetryMask22;emit systemTelemetryMask22Changed();};
    void setsystemTelemetryMask23(bool systemTelemetryMask23) {m_systemTelemetryMask23=systemTelemetryMask23;emit systemTelemetryMask23Changed();};
    void setsystemTelemetryMask24(bool systemTelemetryMask24) {m_systemTelemetryMask24=systemTelemetryMask24;emit systemTelemetryMask24Changed();};
    void setsystemTelemetryMask25(bool systemTelemetryMask25) {m_systemTelemetryMask25=systemTelemetryMask25;emit systemTelemetryMask25Changed();};
    void setsystemTelemetryMask26(bool systemTelemetryMask26) {m_systemTelemetryMask26=systemTelemetryMask26;emit systemTelemetryMask26Changed();};
    void setsystemTelemetryMask27(bool systemTelemetryMask27) {m_systemTelemetryMask27=systemTelemetryMask27;emit systemTelemetryMask27Changed();};
    void setsystemTelemetryMask28(bool systemTelemetryMask28) {m_systemTelemetryMask28=systemTelemetryMask28;emit systemTelemetryMask28Changed();};
    void setsystemTelemetryMask29(bool systemTelemetryMask29) {m_systemTelemetryMask29=systemTelemetryMask29;emit systemTelemetryMask29Changed();};
    void setsystemTelemetryMask30(bool systemTelemetryMask30) {m_systemTelemetryMask30=systemTelemetryMask30;emit systemTelemetryMask30Changed();};
    void setsystemTelemetryMask31(bool systemTelemetryMask31) {m_systemTelemetryMask31=systemTelemetryMask31;emit systemTelemetryMask31Changed();};
    void setsystemTelemetryMask32(bool systemTelemetryMask32) {m_systemTelemetryMask32=systemTelemetryMask32;emit systemTelemetryMask32Changed();};
    void setsystemTelemetryMask33(bool systemTelemetryMask33) {m_systemTelemetryMask33=systemTelemetryMask33;emit systemTelemetryMask33Changed();};
    void setsystemTelemetryMask34(bool systemTelemetryMask34) {m_systemTelemetryMask34=systemTelemetryMask34;emit systemTelemetryMask34Changed();};
    void setsystemTelemetryMask35(bool systemTelemetryMask35) {m_systemTelemetryMask35=systemTelemetryMask35;emit systemTelemetryMask35Changed();};
    void setsystemTelemetryMask36(bool systemTelemetryMask36) {m_systemTelemetryMask36=systemTelemetryMask36;emit systemTelemetryMask36Changed();};
    void setsystemTelemetryMask37(bool systemTelemetryMask37) {m_systemTelemetryMask37=systemTelemetryMask37;emit systemTelemetryMask37Changed();};
    void setsystemTelemetryMask38(bool systemTelemetryMask38) {m_systemTelemetryMask38=systemTelemetryMask38;emit systemTelemetryMask38Changed();};
    void setsystemTelemetryMask39(bool systemTelemetryMask39) {m_systemTelemetryMask39=systemTelemetryMask39;emit systemTelemetryMask39Changed();};
    void setsystemTelemetryMask40(bool systemTelemetryMask40) {m_systemTelemetryMask40=systemTelemetryMask40;emit systemTelemetryMask40Changed();};
    void setsystemTelemetryMask41(bool systemTelemetryMask41) {m_systemTelemetryMask41=systemTelemetryMask41;emit systemTelemetryMask41Changed();};
    void setsystemTelemetryMask42(bool systemTelemetryMask42) {m_systemTelemetryMask42=systemTelemetryMask42;emit systemTelemetryMask42Changed();};
    void setsystemTelemetryMask43(bool systemTelemetryMask43) {m_systemTelemetryMask43=systemTelemetryMask43;emit systemTelemetryMask43Changed();};
    void setsystemTelemetryMask44(bool systemTelemetryMask44) {m_systemTelemetryMask44=systemTelemetryMask44;emit systemTelemetryMask44Changed();};
    void setsystemTelemetryMask45(bool systemTelemetryMask45) {m_systemTelemetryMask45=systemTelemetryMask45;emit systemTelemetryMask45Changed();};
    void setsystemTelemetryMask46(bool systemTelemetryMask46) {m_systemTelemetryMask46=systemTelemetryMask46;emit systemTelemetryMask46Changed();};
    void setsystemTelemetryMask47(bool systemTelemetryMask47) {m_systemTelemetryMask47=systemTelemetryMask47;emit systemTelemetryMask47Changed();};
    void setsystemTelemetryMask48(bool systemTelemetryMask48) {m_systemTelemetryMask48=systemTelemetryMask48;emit systemTelemetryMask48Changed();};
    void setsystemTelemetryMask49(bool systemTelemetryMask49) {m_systemTelemetryMask49=systemTelemetryMask49;emit systemTelemetryMask49Changed();};
    void setsystemTelemetryMask50(bool systemTelemetryMask50) {m_systemTelemetryMask50=systemTelemetryMask50;emit systemTelemetryMask50Changed();};
    void setsystemTelemetryMask51(bool systemTelemetryMask51) {m_systemTelemetryMask51=systemTelemetryMask51;emit systemTelemetryMask51Changed();};
    void setsystemTelemetryMask52(bool systemTelemetryMask52) {m_systemTelemetryMask52=systemTelemetryMask52;emit systemTelemetryMask52Changed();};
    void setsystemTelemetryMask53(bool systemTelemetryMask53) {m_systemTelemetryMask53=systemTelemetryMask53;emit systemTelemetryMask53Changed();};
    void setsystemTelemetryMask54(bool systemTelemetryMask54) {m_systemTelemetryMask54=systemTelemetryMask54;emit systemTelemetryMask54Changed();};
    void setsystemTelemetryMask55(bool systemTelemetryMask55) {m_systemTelemetryMask55=systemTelemetryMask55;emit systemTelemetryMask55Changed();};
    void setsystemTelemetryMask56(bool systemTelemetryMask56) {m_systemTelemetryMask56=systemTelemetryMask56;emit systemTelemetryMask56Changed();};
    void setsystemTelemetryMask57(bool systemTelemetryMask57) {m_systemTelemetryMask57=systemTelemetryMask57;emit systemTelemetryMask57Changed();};
    void setsystemTelemetryMask58(bool systemTelemetryMask58) {m_systemTelemetryMask58=systemTelemetryMask58;emit systemTelemetryMask58Changed();};
    void setsystemTelemetryMask59(bool systemTelemetryMask59) {m_systemTelemetryMask59=systemTelemetryMask59;emit systemTelemetryMask59Changed();};
    void setsystemTelemetryMask60(bool systemTelemetryMask60) {m_systemTelemetryMask60=systemTelemetryMask60;emit systemTelemetryMask60Changed();};
    void setsystemTelemetryMask61(bool systemTelemetryMask61) {m_systemTelemetryMask61=systemTelemetryMask61;emit systemTelemetryMask61Changed();};
    void setsystemTelemetryMask62(bool systemTelemetryMask62) {m_systemTelemetryMask62=systemTelemetryMask62;emit systemTelemetryMask62Changed();};
    void setsystemTelemetryMask63(bool systemTelemetryMask63) {m_systemTelemetryMask63=systemTelemetryMask63;emit systemTelemetryMask63Changed();};

    void setemergencyBoardStatus0(bool emergencyBoardStatus0) {m_emergencyBoardStatus0=emergencyBoardStatus0;emit emergencyBoardStatus0Changed();};
    void setemergencyBoardStatus1(bool emergencyBoardStatus1) {m_emergencyBoardStatus1=emergencyBoardStatus1;emit emergencyBoardStatus1Changed();};
    void setemergencyBoardStatus2(bool emergencyBoardStatus2) {m_emergencyBoardStatus2=emergencyBoardStatus2;emit emergencyBoardStatus2Changed();};
    void setemergencyBoardStatus3(bool emergencyBoardStatus3) {m_emergencyBoardStatus3=emergencyBoardStatus3;emit emergencyBoardStatus3Changed();};
    void setemergencyBoardStatus4(bool emergencyBoardStatus4) {m_emergencyBoardStatus4=emergencyBoardStatus4;emit emergencyBoardStatus4Changed();};
    void setemergencyBoardStatus5(bool emergencyBoardStatus5) {m_emergencyBoardStatus5=emergencyBoardStatus5;emit emergencyBoardStatus5Changed();};
    void setemergencyBoardStatus6(bool emergencyBoardStatus6) {m_emergencyBoardStatus6=emergencyBoardStatus6;emit emergencyBoardStatus6Changed();};
    void setemergencyBoardStatus7(bool emergencyBoardStatus7) {m_emergencyBoardStatus7=emergencyBoardStatus7;emit emergencyBoardStatus7Changed();};
    void setemergencyBoardStatus8(bool emergencyBoardStatus8) {m_emergencyBoardStatus8=emergencyBoardStatus8;emit emergencyBoardStatus8Changed();};
    void setemergencyBoardStatus9(bool emergencyBoardStatus9) {m_emergencyBoardStatus9=emergencyBoardStatus9;emit emergencyBoardStatus9Changed();};
    void setemergencyBoardStatus10(bool emergencyBoardStatus10) {m_emergencyBoardStatus10=emergencyBoardStatus10;emit emergencyBoardStatus10Changed();};
    void setemergencyBoardStatus11(bool emergencyBoardStatus11) {m_emergencyBoardStatus11=emergencyBoardStatus11;emit emergencyBoardStatus11Changed();};
    void setemergencyBoardStatus12(bool emergencyBoardStatus12) {m_emergencyBoardStatus12=emergencyBoardStatus12;emit emergencyBoardStatus12Changed();};
    void setemergencyBoardStatus13(bool emergencyBoardStatus13) {m_emergencyBoardStatus13=emergencyBoardStatus13;emit emergencyBoardStatus13Changed();};
    void setemergencyBoardStatus14(bool emergencyBoardStatus14) {m_emergencyBoardStatus14=emergencyBoardStatus14;emit emergencyBoardStatus14Changed();};
    void setemergencyBoardStatus15(bool emergencyBoardStatus15) {m_emergencyBoardStatus15=emergencyBoardStatus15;emit emergencyBoardStatus15Changed();};

    void setPSUStatus0(bool PSUStatus0) {m_PSUStatus0=PSUStatus0;emit PSUStatus0Changed();};
    void setPSUStatus1(bool PSUStatus1) {m_PSUStatus1=PSUStatus1;emit PSUStatus1Changed();};
    void setPSUStatus2(bool PSUStatus2) {m_PSUStatus2=PSUStatus2;emit PSUStatus2Changed();};
    void setPSUStatus3(bool PSUStatus3) {m_PSUStatus3=PSUStatus3;emit PSUStatus3Changed();};
    void setPSUStatus4(bool PSUStatus4) {m_PSUStatus4=PSUStatus4;emit PSUStatus4Changed();};
    void setPSUStatus5(bool PSUStatus5) {m_PSUStatus5=PSUStatus5;emit PSUStatus5Changed();};
    void setPSUStatus6(bool PSUStatus6) {m_PSUStatus6=PSUStatus6;emit PSUStatus6Changed();};
    void setPSUStatus7(bool PSUStatus7) {m_PSUStatus7=PSUStatus7;emit PSUStatus7Changed();};
    void setPSUStatus8(bool PSUStatus8) {m_PSUStatus8=PSUStatus8;emit PSUStatus8Changed();};
    void setPSUStatus9(bool PSUStatus9) {m_PSUStatus9=PSUStatus9;emit PSUStatus9Changed();};
    void setPSUStatus10(bool PSUStatus10) {m_PSUStatus10=PSUStatus10;emit PSUStatus10Changed();};
    void setPSUStatus11(bool PSUStatus11) {m_PSUStatus11=PSUStatus11;emit PSUStatus11Changed();};
    void setPSUStatus12(bool PSUStatus12) {m_PSUStatus12=PSUStatus12;emit PSUStatus12Changed();};
    void setPSUStatus13(bool PSUStatus13) {m_PSUStatus13=PSUStatus13;emit PSUStatus13Changed();};
    void setPSUStatus14(bool PSUStatus14) {m_PSUStatus14=PSUStatus14;emit PSUStatus14Changed();};
    void setPSUStatus15(bool PSUStatus15) {m_PSUStatus15=PSUStatus15;emit PSUStatus15Changed();};

    void setemergencyRadioLinkStatus0(bool emergencyRadioLinkStatus0) {m_emergencyRadioLinkStatus0=emergencyRadioLinkStatus0;emit emergencyRadioLinkStatus0Changed();};
    void setemergencyRadioLinkStatus1(bool emergencyRadioLinkStatus1) {m_emergencyRadioLinkStatus1=emergencyRadioLinkStatus1;emit emergencyRadioLinkStatus1Changed();};
    void setemergencyRadioLinkStatus2(bool emergencyRadioLinkStatus2) {m_emergencyRadioLinkStatus2=emergencyRadioLinkStatus2;emit emergencyRadioLinkStatus2Changed();};
    void setemergencyRadioLinkStatus3(bool emergencyRadioLinkStatus3) {m_emergencyRadioLinkStatus3=emergencyRadioLinkStatus3;emit emergencyRadioLinkStatus3Changed();};
    void setemergencyRadioLinkStatus4(bool emergencyRadioLinkStatus4) {m_emergencyRadioLinkStatus4=emergencyRadioLinkStatus4;emit emergencyRadioLinkStatus4Changed();};
    void setemergencyRadioLinkStatus5(bool emergencyRadioLinkStatus5) {m_emergencyRadioLinkStatus5=emergencyRadioLinkStatus5;emit emergencyRadioLinkStatus5Changed();};
    void setemergencyRadioLinkStatus6(bool emergencyRadioLinkStatus6) {m_emergencyRadioLinkStatus6=emergencyRadioLinkStatus6;emit emergencyRadioLinkStatus6Changed();};
    void setemergencyRadioLinkStatus7(bool emergencyRadioLinkStatus7) {m_emergencyRadioLinkStatus7=emergencyRadioLinkStatus7;emit emergencyRadioLinkStatus7Changed();};

    void setsystemMsgCounter(int systemMsgCounter) {m_systemMsgCounter=systemMsgCounter;emit systemMsgCounterChanged();};


    /* RADIOLINK */

    void setRSSI(quint16 RSSI) {m_RSSI=RSSI;emit RSSIChanged();};
    void setradiolinkErrorCounter(quint8 radiolinkErrorCounter) {m_radiolinkErrorCounter=radiolinkErrorCounter;emit radiolinkErrorCounterChanged();};
    void setradiolinkMask0(bool radiolinkMask0) {m_radiolinkMask0=radiolinkMask0;emit radiolinkMask0Changed();};
    void setradiolinkMask1(bool radiolinkMask1) {m_radiolinkMask1=radiolinkMask1;emit radiolinkMask1Changed();};
    void setradiolinkMask2(bool radiolinkMask2) {m_radiolinkMask2=radiolinkMask2;emit radiolinkMask2Changed();};
    void setradiolinkMask3(bool radiolinkMask3) {m_radiolinkMask3=radiolinkMask3;emit radiolinkMask3Changed();};
    void setradiolinkMask4(bool radiolinkMask4) {m_radiolinkMask4=radiolinkMask4;emit radiolinkMask4Changed();};
    void setradiolinkMask5(bool radiolinkMask5) {m_radiolinkMask5=radiolinkMask5;emit radiolinkMask5Changed();};
    void setradiolinkMask6(bool radiolinkMask6) {m_radiolinkMask6=radiolinkMask6;emit radiolinkMask6Changed();};
    void setradiolinkMask7(bool radiolinkMask7) {m_radiolinkMask7=radiolinkMask7;emit radiolinkMask7Changed();};
    void setradiolinkMask8(bool radiolinkMask8) {m_radiolinkMask8=radiolinkMask8;emit radiolinkMask8Changed();};
    void setradiolinkMask9(bool radiolinkMask9) {m_radiolinkMask9=radiolinkMask9;emit radiolinkMask9Changed();};
    void setradiolinkMask10(bool radiolinkMask10) {m_radiolinkMask10=radiolinkMask10;emit radiolinkMask10Changed();};
    void setradiolinkMask11(bool radiolinkMask11) {m_radiolinkMask11=radiolinkMask11;emit radiolinkMask11Changed();};
    void setradiolinkMask12(bool radiolinkMask12) {m_radiolinkMask12=radiolinkMask12;emit radiolinkMask12Changed();};
    void setradiolinkMask13(bool radiolinkMask13) {m_radiolinkMask13=radiolinkMask13;emit radiolinkMask13Changed();};
    void setradiolinkMask14(bool radiolinkMask14) {m_radiolinkMask14=radiolinkMask14;emit radiolinkMask14Changed();};
    void setradiolinkMask15(bool radiolinkMask15) {m_radiolinkMask15=radiolinkMask15;emit radiolinkMask15Changed();};
    void setradiolinkMask16(bool radiolinkMask16) {m_radiolinkMask16=radiolinkMask16;emit radiolinkMask16Changed();};
    void setradiolinkMask17(bool radiolinkMask17) {m_radiolinkMask17=radiolinkMask17;emit radiolinkMask17Changed();};
    void setradiolinkMask18(bool radiolinkMask18) {m_radiolinkMask18=radiolinkMask18;emit radiolinkMask18Changed();};
    void setradiolinkMask19(bool radiolinkMask19) {m_radiolinkMask19=radiolinkMask19;emit radiolinkMask19Changed();};
    void setradiolinkMask20(bool radiolinkMask20) {m_radiolinkMask20=radiolinkMask20;emit radiolinkMask20Changed();};
    void setradiolinkMask21(bool radiolinkMask21) {m_radiolinkMask21=radiolinkMask21;emit radiolinkMask21Changed();};
    void setradiolinkMask22(bool radiolinkMask22) {m_radiolinkMask22=radiolinkMask22;emit radiolinkMask22Changed();};
    void setradiolinkMask23(bool radiolinkMask23) {m_radiolinkMask23=radiolinkMask23;emit radiolinkMask23Changed();};
    void setradiolinkMask24(bool radiolinkMask24) {m_radiolinkMask24=radiolinkMask24;emit radiolinkMask24Changed();};
    void setradiolinkMask25(bool radiolinkMask25) {m_radiolinkMask25=radiolinkMask25;emit radiolinkMask25Changed();};
    void setradiolinkMask26(bool radiolinkMask26) {m_radiolinkMask26=radiolinkMask26;emit radiolinkMask26Changed();};
    void setradiolinkMask27(bool radiolinkMask27) {m_radiolinkMask27=radiolinkMask27;emit radiolinkMask27Changed();};
    void setradiolinkMask28(bool radiolinkMask28) {m_radiolinkMask28=radiolinkMask28;emit radiolinkMask28Changed();};
    void setradiolinkMask29(bool radiolinkMask29) {m_radiolinkMask29=radiolinkMask29;emit radiolinkMask29Changed();};
    void setradiolinkMask30(bool radiolinkMask30) {m_radiolinkMask30=radiolinkMask30;emit radiolinkMask30Changed();};
    void setradiolinkMask31(bool radiolinkMask31) {m_radiolinkMask31=radiolinkMask31;emit radiolinkMask31Changed();};

    void setradiolinkMsgCounter(int radiolinkMsgCounter) {m_radiolinkMsgCounter=radiolinkMsgCounter;emit radiolinkMsgCounterChanged();};


    /* GUIDANCE */

    void setguidanceMask0(bool guidanceMask0) {m_guidanceMask0=guidanceMask0;emit guidanceMask0Changed();};
    void setguidanceMask1(bool guidanceMask1) {m_guidanceMask1=guidanceMask1;emit guidanceMask1Changed();};
    void setguidanceMask2(bool guidanceMask2) {m_guidanceMask2=guidanceMask2;emit guidanceMask2Changed();};
    void setguidanceMask3(bool guidanceMask3) {m_guidanceMask3=guidanceMask3;emit guidanceMask3Changed();};
    void setguidanceMask4(bool guidanceMask4) {m_guidanceMask4=guidanceMask4;emit guidanceMask4Changed();};
    void setguidanceMask5(bool guidanceMask5) {m_guidanceMask5=guidanceMask5;emit guidanceMask5Changed();};
    void setguidanceMask6(bool guidanceMask6) {m_guidanceMask6=guidanceMask6;emit guidanceMask6Changed();};
    void setguidanceMask7(bool guidanceMask7) {m_guidanceMask7=guidanceMask7;emit guidanceMask7Changed();};
    void setguidanceMask8(bool guidanceMask8) {m_guidanceMask8=guidanceMask8;emit guidanceMask8Changed();};
    void setguidanceMask9(bool guidanceMask9) {m_guidanceMask9=guidanceMask9;emit guidanceMask9Changed();};
    void setguidanceMask10(bool guidanceMask10) {m_guidanceMask10=guidanceMask10;emit guidanceMask10Changed();};
    void setguidanceMask11(bool guidanceMask11) {m_guidanceMask11=guidanceMask11;emit guidanceMask11Changed();};
    void setguidanceMask12(bool guidanceMask12) {m_guidanceMask12=guidanceMask12;emit guidanceMask12Changed();};
    void setguidanceMask13(bool guidanceMask13) {m_guidanceMask13=guidanceMask13;emit guidanceMask13Changed();};
    void setguidanceMask14(bool guidanceMask14) {m_guidanceMask14=guidanceMask14;emit guidanceMask14Changed();};
    void setguidanceMask15(bool guidanceMask15) {m_guidanceMask15=guidanceMask15;emit guidanceMask15Changed();};
    void setguidanceMask16(bool guidanceMask16) {m_guidanceMask16=guidanceMask16;emit guidanceMask16Changed();};
    void setguidanceMask17(bool guidanceMask17) {m_guidanceMask17=guidanceMask17;emit guidanceMask17Changed();};
    void setguidanceMask18(bool guidanceMask18) {m_guidanceMask18=guidanceMask18;emit guidanceMask18Changed();};
    void setguidanceMask19(bool guidanceMask19) {m_guidanceMask19=guidanceMask19;emit guidanceMask19Changed();};
    void setguidanceMask20(bool guidanceMask20) {m_guidanceMask20=guidanceMask20;emit guidanceMask20Changed();};
    void setguidanceMask21(bool guidanceMask21) {m_guidanceMask21=guidanceMask21;emit guidanceMask21Changed();};
    void setguidanceMask22(bool guidanceMask22) {m_guidanceMask22=guidanceMask22;emit guidanceMask22Changed();};
    void setguidanceMask23(bool guidanceMask23) {m_guidanceMask23=guidanceMask23;emit guidanceMask23Changed();};
    void setguidanceMask24(bool guidanceMask24) {m_guidanceMask24=guidanceMask24;emit guidanceMask24Changed();};
    void setguidanceMask25(bool guidanceMask25) {m_guidanceMask25=guidanceMask25;emit guidanceMask25Changed();};
    void setguidanceMask26(bool guidanceMask26) {m_guidanceMask26=guidanceMask26;emit guidanceMask26Changed();};
    void setguidanceMask27(bool guidanceMask27) {m_guidanceMask27=guidanceMask27;emit guidanceMask27Changed();};
    void setguidanceMask28(bool guidanceMask28) {m_guidanceMask28=guidanceMask28;emit guidanceMask28Changed();};
    void setguidanceMask29(bool guidanceMask29) {m_guidanceMask29=guidanceMask29;emit guidanceMask29Changed();};
    void setguidanceMask30(bool guidanceMask30) {m_guidanceMask30=guidanceMask30;emit guidanceMask30Changed();};
    void setguidanceMask31(bool guidanceMask31) {m_guidanceMask31=guidanceMask31;emit guidanceMask31Changed();};

    void setguidanceMsgCounter(int guidanceMsgCounter) {m_guidanceMsgCounter=guidanceMsgCounter;emit guidanceMsgCounterChanged();};

    /* STORAGE */

    void setstorageFreeDataSize(quint32 storageFreeDataSize) {m_storageFreeDataSize=storageFreeDataSize;emit storageFreeDataSizeChanged();};
    void setstorage0(bool storage0) {m_storage0=storage0;emit storage0Changed();};
    void setstorage1(bool storage1) {m_storage1=storage1;emit storage1Changed();};
    void setstorage2(bool storage2) {m_storage2=storage2;emit storage2Changed();};
    void setstorage3(bool storage3) {m_storage3=storage3;emit storage3Changed();};
    void setstorage4(bool storage4) {m_storage4=storage4;emit storage4Changed();};
    void setstorage5(bool storage5) {m_storage5=storage5;emit storage5Changed();};
    void setstorage6(bool storage6) {m_storage6=storage6;emit storage6Changed();};
    void setstorage7(bool storage7) {m_storage7=storage7;emit storage7Changed();};
    void setstorage8(bool storage8) {m_storage8=storage8;emit storage8Changed();};
    void setstorage9(bool storage9) {m_storage9=storage9;emit storage9Changed();};
    void setstorage10(bool storage10) {m_storage10=storage10;emit storage10Changed();};
    void setstorage11(bool storage11) {m_storage11=storage11;emit storage11Changed();};
    void setstorage12(bool storage12) {m_storage12=storage12;emit storage12Changed();};
    void setstorage13(bool storage13) {m_storage13=storage13;emit storage13Changed();};
    void setstorage14(bool storage14) {m_storage14=storage14;emit storage14Changed();};
    void setstorage15(bool storage15) {m_storage15=storage15;emit storage15Changed();};
    void setstorage16(bool storage16) {m_storage16=storage16;emit storage16Changed();};
    void setstorage17(bool storage17) {m_storage17=storage17;emit storage17Changed();};
    void setstorage18(bool storage18) {m_storage18=storage18;emit storage18Changed();};
    void setstorage19(bool storage19) {m_storage19=storage19;emit storage19Changed();};
    void setstorage20(bool storage20) {m_storage20=storage20;emit storage20Changed();};
    void setstorage21(bool storage21) {m_storage21=storage21;emit storage21Changed();};
    void setstorage22(bool storage22) {m_storage22=storage22;emit storage22Changed();};
    void setstorage23(bool storage23) {m_storage23=storage23;emit storage23Changed();};
    void setstorage24(bool storage24) {m_storage24=storage24;emit storage24Changed();};
    void setstorage25(bool storage25) {m_storage25=storage25;emit storage25Changed();};
    void setstorage26(bool storage26) {m_storage26=storage26;emit storage26Changed();};
    void setstorage27(bool storage27) {m_storage27=storage27;emit storage27Changed();};
    void setstorage28(bool storage28) {m_storage28=storage28;emit storage28Changed();};
    void setstorage29(bool storage29) {m_storage29=storage29;emit storage29Changed();};
    void setstorage30(bool storage30) {m_storage30=storage30;emit storage30Changed();};
    void setstorage31(bool storage31) {m_storage31=storage31;emit storage31Changed();};

    void setstorageMsgCounter(int storageMsgCounter) {m_storageMsgCounter=storageMsgCounter;emit storageMsgCounterChanged();};

    void setmsgTelemetryOld(bool msgTelemetryOld) {m_msgTelemetryOld=msgTelemetryOld;emit msgTelemetryOldChanged();};
    void setmsgGuidanceOld(bool msgGuidanceOld) {m_msgGuidanceOld=msgGuidanceOld;emit msgGuidanceOldChanged();};
    void setmsgStorageOld(bool msgStorageOld) {m_msgStorageOld=msgStorageOld;emit msgStorageOldChanged();};
    void setmsgSystemOld(bool msgSystemOld) {m_msgSystemOld=msgSystemOld;emit msgSystemOldChanged();};
    void setmsgRadioLinkOld(bool msgRadioLinkOld) {m_msgRadioLinkOld=msgRadioLinkOld;emit msgRadioLinkOldChanged();};
    void setmsgMotorOld(bool msgMotorOld) {m_msgMotorOld=msgMotorOld;emit msgMotorOldChanged();};
    ...
    /* TBD */
    void setGSRLErrorCounter(quint8 GSRLErrorCounter) {m_GSRLErrorCounter=GSRLErrorCounter;emit GSRLErrorCounterChanged();};
    void setFSRLErrorCounter(quint8 FSRLErrorCounter) {m_FSRLErrorCounter=FSRLErrorCounter;emit FSRLErrorCounterChanged();};
    void setRLHeartbeatCounter(quint8 RLHeartbeatCounter) {m_RLHeartbeatCounter=RLHeartbeatCounter;emit RLHeartbeatCounterChanged();};
    void setgnssFound(bool gnssFound) {m_gnssFound=gnssFound;emit gnssFoundChanged();};
